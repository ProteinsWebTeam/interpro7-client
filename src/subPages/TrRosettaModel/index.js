...
const TrRosettaModel = ({ data, dataContacts, urlForModel, accession }) => {
  ...
  return (
    <div className={f('row', 'column')} ref={container}>
      <h3>trRosetta structure prediction</h3>
      <div>
        The protein structural below was generated by the{' '}
        <Link href="https://www.bakerlab.org/">Baker group</Link>{' '}
        with the trRosetta software{' '}
        <Tooltip
          html={
            <PrintedPublication
