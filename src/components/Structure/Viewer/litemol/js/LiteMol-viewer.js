...
(function(LiteMol) {
  ...
  (function(Viewer) {
    ...
    (function(DataSources) {
      ...
      DataSources.DownloadMolecule = Entity.Transformer.Molecule.downloadMoleculeSource(
        {
          ...
          defaultId:
            'https://webchem.ncbr.muni.cz/CoordinateServer/1tqn/cartoon',
      ...
      DataSources.ObtainDownloadSources = [
        'CoordinateServer',
        'PDBe Updated mmCIF',
        'URL',
        'File on Disk',
            ...
            return {
              ...
              sources: {
                CoordinateServer: {
                  ...
                  serverUrl: ctx.settings.get(
                    'molecule.downloadBinaryCIFFromCoordinateServer.server',
                  )
                    ? ctx.settings.get(
                        'molecule.downloadBinaryCIFFromCoordinateServer.server',
                      )
          ...
          validateParams: function(p) {
            ...
            switch (src.kind) {
              case 'CoordinateServer':
                return !src.id || !src.id.trim().length
                  ? ['Enter Id']
                  : !src.serverUrl || !src.serverUrl.trim().length
                    ? ['Enter CoordinateServer base URL']
                    : void 0;
              case 'PDBe Updated mmCIF':
                return !src.id || !src.id.trim().length ? ['Enter Id'] : void 0;
              case 'URL':
                return !src.url || !src.url.trim().length
                  ? ['Enter URL']
                  : void 0;
              case 'File on Disk':
        ...
        function(context, a, t) {
          ...
          switch (src.kind) {
            case 'CoordinateServer':
              transform.add(
                a,
                Viewer.PDBe.Data.DownloadBinaryCIFFromCoordinateServer,
                src,
              );
              break;
            case 'PDBe Updated mmCIF':
              transform.add(a, Viewer.PDBe.Data.DownloadMolecule, {
                id: src.id,
              });
              break;
            case 'URL':
              transform.add(a, DataSources.DownloadMolecule, {
                format: src.format,
                id: src.url,
              });
              break;
            case 'File on Disk':
              transform.add(
                a,
                Bootstrap.Entity.Transformer.Molecule.OpenMoleculeFromFile,
                { file: src.file },
              );
              break;
          }
...
(function(LiteMol) {
  ...
  (function(Viewer) {
    ...
    (function(ValidatorDB) {
      ...
      ValidatorDB.Report = Entity.create({
        name: 'Ligand Validation Report',
        typeClass: 'Behaviour',
        shortName: 'VR',
        description: 'Represents ValidatorDB ligand validation report.',
      });
      var Api;
      (function(Api) {
        ...
        var RedFlags = LiteMol.Core.Utils.FastSet.ofArray([
          'Missing',
          'NotAnalyzed',
        ]);
        ...
        function createReport(data) {
          ...
          for (var _i = 0, _a = data.Models; _i < _a.length; _i++) {
            ...
            for (var _b = 0, _c = model.Entries; _b < _c.length; _b++) {
              ...
              for (
                var _d = 0, _e = Object.keys(chiralityMismatches);
                _d < _e.length;
                _d++
              ) {
                var _m = _e[_d];
                if (
                  !Object.prototype.hasOwnProperty.call(chiralityMismatches, _m)
                )
                  continue;
              ...
              residueReport.set(residue.authSeqNumber, {
                ...
                flags: flags,
                chiralityMismatches: chiralityMismatchSet
                  ? chiralityMismatchSet
                  : emptySet,
              });
            }
          }
      ...
      (function(Interactivity) {
        var Behaviour = /** @class */ (function() {
          ...
          Behaviour.prototype.processInfo = function(info) {
            var i = LiteMol.Bootstrap.Interactivity.Molecule.transformInteraction(
              info,
            );
            ...
            if (i.atoms.length === 1) {
              ...
              var badChirality = residue
                ? residue.chiralityMismatches.has(a.name)
                : false;
              if (!residue) return void 0;
              return (
                '<div><small>[Validation]</small> Atom: <b>' +
                (badChirality ? 'Bad Chirality' : 'OK') +
                '</b>, Residue: <b>' +
                residue.flags.join(', ') +
                '</b></div>'
              );
              ...
              if (!residue) return void 0;
              return (
                '<div><small>[Validation]</small> Residue: <b>' +
                residue.flags.join(', ') +
                '</b></div>'
              );
            }
        ...
        (Interactivity =
          ValidatorDB.Interactivity || (ValidatorDB.Interactivity = {})),
      );
      var Theme;
      (function(Theme) {
        ...
        function createAtomMapNormal(model, report) {
          ...
          var _a = model.data.residues,
            authAsymId = _a.authAsymId,
            authSeqNumber = _a.authSeqNumber,
          ...
          for (var rI = 0, _rI = model.data.residues.count; rI < _rI; rI++) {
            ...
            for (
              var aI = atomStartIndex[rI], _aI = atomEndIndex[rI];
              aI < _aI;
              aI++
            ) {
        ...
        function create(entity, report) {
          ...
          var map =
            model.source === LiteMol.Core.Structure.Molecule.Model.Source.File
          ...
          var mapping = LiteMol.Visualization.Theme.createColorMapMapping(
            function(i) {
              return map[i];
            },
            colorMap,
      ...
      var Create = LiteMol.Bootstrap.Tree.Transformer.create(
        ...
        function(context, a, t) {
          return LiteMol.Bootstrap.Task.create(
            'ValidatorDB Report (' + t.params.id + ')',
            'Normal',
            function(ctx) {
                ...
                return __generator(this, function(_a) {
                  switch (_a.label) {
                    ...
                    case 1:
                      ...
                      return [
                        2 /*return*/,
                        ValidatorDB.Report.create(t, {
                          label: 'Ligand Validation Report',
                          behaviour: new Interactivity.Behaviour(
                            context,
                            report,
                          ),
                        }),
        ...
        function(context, a, t) {
          ...
          var action = LiteMol.Bootstrap.Tree.Transform.build()
            .add(a, Transformer.Data.Download, {
              url:
                'https://webchem.ncbr.muni.cz/Platform/ValidatorDb/Data/' +
                id +
                '?source=ByStructure',
              type: 'String',
              id: id,
            ...
            .then(
              Create,
              { id: id },
              { isBinding: true, ref: t.params.reportRef },
            );
          return action;
        },
          ...
          return LiteMol.Bootstrap.Task.create(
            ...
            function(ctx) {
              return __awaiter(_this, void 0, void 0, function() {
                ...
                return __generator(this, function(_a) {
                  molecule = LiteMol.Bootstrap.Tree.Node.findAncestor(
                    a,
                    LiteMol.Bootstrap.Entity.Molecule.Molecule,
                  );
                  if (!molecule) {
                    throw 'No suitable parent found.';
                  }
                  themes = LiteMol.Core.Utils.FastMap.create();
                  visuals = context.select(
                    LiteMol.Bootstrap.Tree.Selection.byValue(molecule)
                      .subtree()
                  ...
                  for (
                    ...
                    LiteMol.Bootstrap.Command.Visual.UpdateBasicTheme.dispatch(
                      context,
                      { visual: v, theme: theme },
                    );
                  }
    ...
    (function(DensityStreaming) {
      ...
      (function(ServerDataFormat) {
        ...
        (function(ValueType) {
          ...
          (ValueType =
            ServerDataFormat.ValueType || (ServerDataFormat.ValueType = {})),
        );
      })(
        (ServerDataFormat =
          DensityStreaming.ServerDataFormat ||
          (DensityStreaming.ServerDataFormat = {})),
      );
    })(
      (DensityStreaming =
        Extensions.DensityStreaming || (Extensions.DensityStreaming = {})),
    );
...
(function(LiteMol) {
  ...
  (function(Extensions) {
    ...
    (function(DensityStreaming) {
      ...
      DensityStreaming.Streaming = Entity.create({
      ...
      DensityStreaming.CreateStreaming = Tree.Transformer.create(
        {
          ...
          description:
            'On demand download of density data when a residue or atom is selected.',
          from: [],
          ...
          customController: function(ctx, t, e) {
            return new LiteMol.Bootstrap.Components.Transform.DensityVisual(
              ctx,
              t,
              e,
            );
        ...
        function(ctx, a, t) {
          ...
          return LiteMol.Bootstrap.Task.resolve(
            'Behaviour',
            'Background',
            DensityStreaming.Streaming.create(t, {
              label: 'Density Streaming',
              behaviour: b,
            }),
          );
        },
                ...
                return __generator(this, function(_a) {
                  switch (_a.label) {
                    case 0:
                      ...
                      return [
                        4 /*yield*/,
                        b.props.behaviour.invalidateParams(t.params),
                      ];
                    case 1:
                      _a.sent();
                      return [3 /*break*/, 4];
      ...
      DensityStreaming.Setup = LiteMol.Bootstrap.Tree.Transformer.actionWithContext(
        {
          ...
          defaultParams: function(ctx, e) {
            var source = 'X-ray';
            var method = (
              e.props.molecule.properties.experimentMethod || ''
            ).toLowerCase();
            if (method.indexOf('microscopy') >= 0) source = 'EM';
            return {
              server: ctx.settings.get(
                'extensions.densityStreaming.defaultServer',
              ),
        ...
        function(context, a, t) {
          switch (t.params.source) {
            case 'X-ray':
              return enableStreaming(a, context, t.params);
            case 'EM':
              return doEm(a, context, t.params);
            default:
              return fail(a, 'Unknown data source.');
          }
        },
      );
      function fail(e, message) {
        return {
          action: LiteMol.Bootstrap.Tree.Transform.build().add(
            e,
            Transformer.Basic.Fail,
            { title: 'Density Streaming', message: message },
          ),
          context: void 0,
        };
      }
      function doAction(m, params, header, sourceId, contourLevel) {
          ...
          params.source === 'EM'
            ? {
                EM: LiteMol.Bootstrap.Visualization.Density.Style.create({
                  ...
                  isoValueType:
                    contourLevel !== void 0
                      ? LiteMol.Bootstrap.Visualization.Density.IsoValueType
                          .Absolute
                      : LiteMol.Bootstrap.Visualization.Density.IsoValueType
                          .Sigma,
        ...
        var streaming = __assign(
          {
            ...
            header: header,
            isoValueType:
              params.source === 'X-ray' || contourLevel === void 0
                ? LiteMol.Bootstrap.Visualization.Density.IsoValueType.Sigma
                : LiteMol.Bootstrap.Visualization.Density.IsoValueType.Absolute,
            isoValues:
              params.source === 'X-ray'
                ? { '2Fo-Fc': 1.5, 'Fo-Fc(+ve)': 3, 'Fo-Fc(-ve)': -3 }
                : { EM: contourLevel !== void 0 ? contourLevel : 1.5 },
            displayType:
              params.source === 'X-ray' ? 'Around Selection' : 'Everything',
        ...
        return {
          action: LiteMol.Bootstrap.Tree.Transform.build().add(
            m,
            DensityStreaming.CreateStreaming,
            streaming,
            { ref: params.streamingEntityRef },
          ),
          context: void 0,
        };
      }
            ...
            switch (_a.label) {
              case 0:
                ...
                uri =
                  ...
                  params.source +
                  '/' +
                  (sourceId ? sourceId : params.id);
                return [
                  4 /*yield*/,
                  LiteMol.Bootstrap.Utils.ajaxGetString(
                    uri,
                    'DensityServer',
                  ).run(ctx),
                ];
                ...
                try {
                  ...
                  if (!header.isAvailable) {
                    return [
                      ...
                      fail(
                        m,
                        "Density streaming is not available for '" +
                          params.source +
                          '/' +
                          params.id +
                          "'.",
                  ...
                  header.channels = header.channels.map(function(c) {
                    return c.toUpperCase();
                  });
                  return [
                    2 /*return*/,
                    doAction(m, params, header, sourceId, contourLevel),
                  ];
                } catch (e) {
                  return [
                    2 /*return*/,
                    fail(e, 'DensityServer API call failed.'),
                  ];
                }
                return [2 /*return*/];
            }
            ...
            switch (_a.label) {
              case 0:
                ...
                return [
                  4 /*yield*/,
                  LiteMol.Bootstrap.Utils.ajaxGetString(
                    'https://www.ebi.ac.uk/pdbe/api/emdb/entry/map/' + id,
                    'EMDB API',
                  ).run(ctx),
                ];
              case 1:
              ...
              case 2:
                ...
                if (
                  ...
                  e[0] &&
                  e[0].map &&
                  e[0].map.contour_level &&
                  e[0].map.contour_level.value !== void 0
                ) {
                  contour = +e[0].map.contour_level.value;
                }
                return [
                  4 /*yield*/,
                  enableStreaming(m, ctx, params, id, contour),
                ];
              case 3:
            ...
            switch (_a.label) {
              case 0:
                ...
                return [
                  4 /*yield*/,
                  LiteMol.Bootstrap.Utils.ajaxGetString(
                    'https://www.ebi.ac.uk/pdbe/api/pdb/entry/summary/' + id,
                    'PDB API',
                  ).run(ctx),
                ];
              case 1:
              ...
              case 2:
                ...
                if (e && e[0] && e[0].related_structures) {
                  ...
                  if (!emdb.length) {
                    return [
                      2 /*return*/,
                      fail(m, "No related EMDB entry found for '" + id + "'."),
                    ];
                  }
    ...
    (function(DensityStreaming) {
      ...
      var Behaviour = /** @class */ (function() {
        ...
        Behaviour.prototype.areBoxesSame = function(b) {
          ...
          for (var i = 0; i < 3; i++) {
            if (
              b.a[i] !== this.selectionBox.a[i] ||
              b.b[i] !== this.selectionBox.b[i]
            )
              return false;
          }
          return true;
        ...
        Behaviour.prototype.getModelBoundingBox = function() {
          ...
          var _a = Utils.Molecule.getBox(
              sourceMolecule.props.molecule.models[0],
              sourceMolecule.props.molecule.models[0].data.atoms.indices,
        ...
        Behaviour.prototype.remove = function(ref) {
          for (
            var _i = 0, _a = this.context.select(ref);
            _i < _a.length;
            _i++
          ) {
            var e = _a[_i];
        ...
        Behaviour.prototype.clear = function() {
          ...
          this.groups.requested.forEach(function(g) {
            return _this.groups.toBeRemoved.add(g);
          });
          this.groups.locked.forEach(function(g) {
            return _this.groups.toBeRemoved.add(g);
          });
          this.groups.shown.forEach(function(g) {
            if (!_this.groups.locked.has(g)) _this.remove(g);
          });
        ...
        Behaviour.prototype.checkResult = function(data) {
          var server = data.dataBlocks.filter(function(b) {
            return b.header === 'SERVER';
          })[0];
          if (!server) return false;
          var cat = server.getCategory('_density_server_result');
          if (!cat) return false;
          if (
            cat.getColumn('is_empty').getString(0) === 'yes' ||
            cat.getColumn('has_error').getString(0) === 'yes'
          ) {
            return false;
          }
          return true;
        ...
        Behaviour.prototype.finish = function() {
          ...
          this.context.logger.info(
            '[Density] Streaming done in ' +
              this.performance.formatTime('query') +
          ...
          return __awaiter(this, void 0, void 0, function() {
            ...
            return __generator(this, function(_a) {
              switch (_a.label) {
                case 0:
                  _a.trys.push([0, 5, , 6]);
                  if (!this.channels) return [2 /*return*/];
                  this.syncStyles();
                  ...
                  styles = this.params;
                  group.then(
                    Transformer.Density.CreateFromData,
                    { id: '2Fo-Fc', data: twoF },
                    { ref: ref + '2Fo-Fc-data' },
                  );
                  group.then(
                ...
                case 1:
                  _a.sent();
                  a = this.apply(
                    LiteMol.Bootstrap.Tree.Transform.build().add(
                      ref + '2Fo-Fc-data',
                      Transformer.Density.CreateVisual,
                      { style: styles['2Fo-Fc'] },
                      { ref: ref + '2Fo-Fc' },
                    ),
                  );
        ...
        Behaviour.prototype.createEm = function() {
          ...
          try {
            ...
            LiteMol.Bootstrap.Tree.Transform.apply(this.context, action)
              .run()
              .then(function() {
                _this.finish();
                _this.groupDone(ref_1, true);
              })
              .catch(function() {
                return _this.groupDone(ref_1, false);
              });
          } catch (e) {
        ...
        Behaviour.getChannel = function(data, name) {
          var block = data.dataBlocks.filter(function(b) {
            return b.header === name;
          })[0];
          if (!block) {
            return void 0;
          }
        ...
        Behaviour.prototype.query = function(box) {
          ...
          this.download = Utils.ajaxGetArrayBuffer(
            url,
            'Density',
          ...
          this.download.result.then(function(data) {
            ...
            if (!_this.channels) return;
            _this.wasCached = false;
            LiteMol.Bootstrap.Utils.LRUCache.set(
              _this.cache,
              url,
              _this.channels,
            );
            if (_this.params.source === 'EM') _this.createEm();
            else _this.createXray();
          });
        };
        Behaviour.prototype.tryUpdateSelectionDataBox = function(info) {
          var i = info;
          if (
            !Interactivity.Molecule.isMoleculeModelInteractivity(info) ||
            !this.isSameMolecule(i)
          ) {
          ...
          var _a = Utils.Molecule.getBox(m, elems, 0),
            a = _a.bottomLeft,
            b = _a.topRight;
          var box = { a: a, b: b };
        ...
        Behaviour.prototype.update = function() {
          return __awaiter(this, void 0, void 0, function() {
            return __generator(this, function(_a) {
              LiteMol.Bootstrap.Command.Toast.Hide.dispatch(this.context, {
                key: ToastKey,
              });
        ...
        Behaviour.prototype.toSigma = function(type) {
          var index = this.params.header.channels.indexOf(
            DensityStreaming.IsoInfo[type].dataKey,
          );
        ...
        Behaviour.prototype.syncStyles = function() {
          var taskType =
            this.params.displayType === 'Everything'
              ? 'Background'
              : this.params.radius > 15 ? 'Background' : 'Silent';
          var isSigma =
            this.params.isoValueType ===
            LiteMol.Bootstrap.Visualization.Density.IsoValueType.Sigma;
          for (var _i = 0, _a = this.types; _i < _a.length; _i++) {
            var t = _a[_i];
            var oldStyle = this.params[t];
            var oldParams = oldStyle.params;
            var isoValue = isSigma ? this.params.isoValues[t] : this.toSigma(t);
            this.params[t] = __assign({}, oldStyle, {
              taskType: taskType,
              params: __assign({}, oldParams, {
                isoValueType:
                  LiteMol.Bootstrap.Visualization.Density.IsoValueType.Sigma,
                isoValue: isoValue,
              }),
        ...
        Behaviour.prototype.updateVisual = function(v, style) {
          return Entity.Transformer.Density.CreateVisual.create(
            { style: style },
            { ref: v.ref },
          )
            .update(this.context, v)
            .run();
        };
        Behaviour.prototype.invalidateStyles = function() {
          return __awaiter(this, void 0, void 0, function() {
            ...
            return __generator(this, function(_c) {
              switch (_c.label) {
                case 0:
                  if (this.groups.shown.size === 0) return [2 /*return*/];
                  this.syncStyles();
                  styles = this.params;
                  refs = [];
                  ...
                  _loop_1 = function(t) {
                    ...
                    return __generator(this, function(_b) {
                      switch (_b.label) {
                        case 0:
                          s = styles[t];
                          if (!s) return [2 /*return*/, 'continue'];
                          vs = this_1.context.select(
                            (_a = LiteMol.Bootstrap.Tree.Selection).byRef.apply(
                              _a,
                              refs.map(function(r) {
                                return r + t;
                              }),
            ...
            return __generator(this, function(_a) {
              switch (_a.label) {
                case 0:
                  ...
                  if (
                    oldParams.displayType !== newParams.displayType ||
        ...
        Behaviour.prototype.register = function(behaviour) {
          ...
          LiteMol.Bootstrap.Command.Toast.Show.dispatch(this.context, {
            key: ToastKey,
            title: 'Density',
            message: message,
            timeoutMs: 30 * 1000,
          ...
          this.obs.push(
            this.context.behaviours.select.subscribe(function(e) {
    ...
    (function(DensityStreaming) {
        ...
        CreateView.prototype.renderControls = function() {
          ...
          return React.createElement(
            ...
            React.createElement(Controls.OptionsGroup, {
              options: DensityStreaming.FieldSources,
              caption: function(s) {
                return s;
              },
              current: params.source,
              onChange: function(o) {
                return _this.updateParams({ source: o });
              },
              label: 'Source',
            ...
            React.createElement(Controls.TextBoxGroup, {
              value: params.server,
              onChange: function(v) {
                return _this.updateParams({ server: v });
              },
              label: 'Server',
              onEnter: function(e) {
                return _this.applyEnter(e);
      ...
      var StreamingView = /** @class */ (function(_super) {
        ...
        StreamingView.prototype.updateIso = function(type, v) {
          var isoValues = __assign(
            {},
            this.params.isoValues,
            ((_a = {}), (_a[type] = v), _a),
          );
        ...
        StreamingView.prototype.iso = function(type) {
          ...
          var valuesIndex = params.header.channels.indexOf(
            DensityStreaming.IsoInfo[type].dataKey,
          );
          var baseValuesInfo =
            params.header.sampling[0].valuesInfo[valuesIndex];
          var sampledValuesInfo =
            params.header.sampling[params.header.sampling.length - 1]
              .valuesInfo[valuesIndex];
          var isoInfo = DensityStreaming.IsoInfo[type];
          var value = params.isoValues[type];
          var sigmaMin =
            (sampledValuesInfo.min - sampledValuesInfo.mean) /
            sampledValuesInfo.sigma;
          var sigmaMax =
            (sampledValuesInfo.max - sampledValuesInfo.mean) /
            sampledValuesInfo.sigma;
          var min, max;
          if (isSigma) {
            if (type === 'EM') {
              min = Math.max(
                (baseValuesInfo.min - baseValuesInfo.mean) /
                  baseValuesInfo.sigma,
                sigmaMin,
              );
              max = Math.min(
                (baseValuesInfo.max - baseValuesInfo.mean) /
                  baseValuesInfo.sigma,
                sigmaMax,
              );
            } else {
            ...
            min = Math.max(
              baseValuesInfo.mean + sigmaMin * baseValuesInfo.sigma,
              baseValuesInfo.min,
            );
            max = Math.min(
              baseValuesInfo.mean + sigmaMax * baseValuesInfo.sigma,
              baseValuesInfo.max,
            );
          }
          return React.createElement(Controls.Slider, {
            label: label,
            onChange: function(v) {
              return _this.updateIso(type, v);
            },
            min: min,
            max: max,
            value: value,
        ...
        StreamingView.prototype.style = function(type) {
          var _this = this;
          var showTypeOptions = this.getPersistentState(
          ...
          return React.createElement(Controls.ExpandableGroup, {
            select: this.iso(type),
            expander: React.createElement(Controls.ControlGroupExpander, {
              isExpanded: showTypeOptions,
              onChange: function(e) {
                return _this.setPersistentState('showTypeOptions-' + type, e);
              },
            }),
            colorStripe: color,
            options: [
              React.createElement(Controls.ToggleColorPicker, {
                key: 'Uniform',
                label: 'Color',
                color: color,
                onChange: function(c) {
                  return _this.controller.updateThemeColor('Uniform', c, type);
                },
              }),
              React.createElement(
                LiteMol.Plugin.Views.Transform.TransparencyControl,
                {
                  definition: theme.transparency,
                  onChange: function(d) {
                    return _this.controller.updateThemeTransparency(d, type);
                  },
                },
              ),
              React.createElement(Controls.Toggle, {
                onChange: function(v) {
                  return _this.controller.updateStyleParams(
                    { isWireframe: v },
                    type,
                  );
                },
                value: params.isWireframe,
                label: 'Wireframe',
              }),
            ],
            isExpanded: showTypeOptions,
        ...
        StreamingView.prototype.details = function() {
          ...
          return React.createElement(Controls.OptionsGroup, {
            ...
            current: options[detailLevel],
            title: 'Determines the detail level of the surface.',
            onChange: function(o) {
              return _this.autoUpdateParams({
                detailLevel: options.indexOf(o),
              });
            },
            label: 'Max Voxels',
          });
        ...
        StreamingView.prototype.updateValueType = function(toSigma) {
          ...
          var newValues = {};
          for (
            var _i = 0, _a = Object.getOwnPropertyNames(params.isoValues);
            _i < _a.length;
            _i++
          ) {
            var k = _a[_i];
            var valuesIndex = params.header.channels.indexOf(
              DensityStreaming.IsoInfo[k].dataKey,
            );
        ...
        StreamingView.prototype.displayType = function() {
          var _this = this;
          var showDisplayOptions = this.getPersistentState(
            'showDisplayOptions',
            false,
          );
          var params = this.params;
          var isSigma =
            params.isoValueType ===
            LiteMol.Bootstrap.Visualization.Density.IsoValueType.Sigma;
          var show = React.createElement(Controls.OptionsGroup, {
            options: ['Everything', 'Around Selection'],
            caption: function(s) {
              return s;
            },
            current: params.displayType,
            onChange: function(o) {
              return _this.autoUpdateParams({ displayType: o });
            },
            label: 'Show',
          });
          return React.createElement(Controls.ExpandableGroup, {
            ...
            expander: React.createElement(Controls.ControlGroupExpander, {
              ...
              onChange: function(e) {
                return _this.setPersistentState('showDisplayOptions', e);
              },
            }),
            options: [
              this.details(),
              React.createElement(Controls.Toggle, {
                onChange: function(v) {
                  return _this.updateValueType(v);
                },
                value: isSigma,
                label: 'Relative (\\u03C3)',
                title:
                  'Specify contour level as relative (\\u03C3) or absolute value.',
              }),
            ],
            isExpanded: showDisplayOptions,
          });
        ...
        StreamingView.prototype.renderControls = function() {
          ...
          return React.createElement(
            ...
            params.displayType === 'Everything'
              ? void 0
              : React.createElement(Controls.Slider, {
                  label: 'Radius',
                  onChange: function(v) {
                    return _this.autoUpdateParams({ radius: v });
                  },
                  min: 0,
    ...
    (function(ComplexReprensetation) {
      ...
      (function(Carbohydrates) {
        ...
        (function(Shapes) {
          ...
          Shapes.Cube = toSurface(
            new THREE.BoxGeometry(2 * sqSide, 2 * sqSide, 2 * sqSide),
          );
          Shapes.Diamond = toSurface(new THREE.OctahedronGeometry(1.3, 0));
          Shapes.Cone = toSurface(
            new THREE.CylinderGeometry(0, 1, 1.6, 32, 1),
            [0, 0.5, 0],
          );
          Shapes.ConeLeft = toSurface(
            new THREE.CylinderGeometry(0, 1, 1.6, 16, 1, false, 0, Math.PI),
            [0, 0.5, 0],
          );
          Shapes.ConeRight = toSurface(
            new THREE.CylinderGeometry(0, 1, 1.6, 16, 1, false, 0, -Math.PI),
            [0, 0.5, 0],
          );
          Shapes.Star = toSurface(star());
          Shapes.FlatRectangle = toSurface(
            new THREE.BoxGeometry(sqSide, sqSide, 2 * sqSide),
          );
          Shapes.FlatDiamond = toSurface(polygon(4, 0.66));
          Shapes.FlatPentagon = toSurface(polygon(5, 0.66));
          Shapes.FlatHexagon = toSurface(polygon(6, 0.66), void 0, [
            0.75,
            1,
            1,
          ]);
          ...
          function polygon(numPts, height) {
            ...
            var extrudePath = new THREE.LineCurve3(
          ...
          function stripe(s) {
            var lower = Math.ceil(s.triangleCount / 2),
              upper = Math.floor(s.triangleCount / 2);
            var lowIndices = new Uint32Array(lower * 3),
              upIndices = new Uint32Array(upper * 3);
            var li = 0,
              ui = 0;
            ...
            return [
              __assign({}, s, {
                triangleCount: lower,
                triangleIndices: lowIndices,
                boundingSphere: void 0,
              }),
              __assign({}, s, {
                triangleCount: upper,
                triangleIndices: upIndices,
                boundingSphere: void 0,
              }),
            ];
          }
          ...
          function ringPlane(model, _a) {
            var ringAtoms = _a.ringAtoms,
              ringCenter = _a.ringCenter;
            var _b = model.positions,
              x = _b.x,
              y = _b.y,
              z = _b.z;
            // determine the ring plane from C2, C4, O
            var o = ringAtoms[ringAtoms.length - 1],
              c2 = ringAtoms[1],
              c4 = ringAtoms[3];
            var dU = Vec3.sub(
              Vec3(),
          ...
          function getRotation(majorAxis, minorAxis, entry) {
            var _a = entry.representation,
              upVector = _a.axisUp,
              sideVector = _a.axisSide;
            var majorRotation = Vec3.makeRotation(
              majorRotationTemp,
              upVector,
              majorAxis,
            );
            ...
            var angle =
              sign(side, minorAxis, majorAxis) * Vec3.angle(side, minorAxis);
            var minorRotation =
          ...
          function findRotation(ringNormal, towardsC1, entry, type) {
            ...
            var links = entry.links,
              terminalLinks = entry.terminalLinks;
            ...
            if (linkCount > 1 && terminalLinkCount > 0) {
              ...
              //minorAxis = towardsC1;
              for (
                var _i = 0, terminalLinks_1 = terminalLinks;
                _i < terminalLinks_1.length;
                _i++
              ) {
          ...
          function makeTransform(model, entry, radiusFactor, type) {
            var ringCenter = entry.ringCenter,
              ringRadius = entry.ringRadius;
            var _a = ringPlane(model, entry),
              ringNormal = _a.ringNormal,
              towardsC1 = _a.towardsC1;
            var rotation = findRotation(ringNormal, towardsC1, entry, type);
            var radius = radiusFactor * ringRadius;
            return {
              scale: [radius, radius, radius],
              rotation: rotation,
              translation: ringCenter,
            };
          }
        ...
        (Carbohydrates =
          ComplexReprensetation.Carbohydrates ||
          (ComplexReprensetation.Carbohydrates = {})),
      );
    })(
      (ComplexReprensetation =
        Extensions.ComplexReprensetation ||
        (Extensions.ComplexReprensetation = {})),
    );
  })((Extensions = LiteMol.Extensions || (LiteMol.Extensions = {})));
})(LiteMol || (LiteMol = {}));
      ...
      (function(Carbohydrates) {
        ...
        (function(Mapping) {
          ...
          var data = [
            ...
            /* === Crossed cube  === */
            {
              shape: Carbohydrates.Shapes.stripe(
                Carbohydrates.Shapes.Cube,
              ) /* Crossed cube  */,
              axisUp: [0, 0, 1],
              instances: [
                {
            ...
            /* === Divided diamond  === */
            {
              shape: Carbohydrates.Shapes.split(
                Carbohydrates.Shapes.Diamond,
              ) /* Divided diamond  */,
              axisUp: [1, 0, 0],
              instances: [
                {
            ...
            {
              shape: [
                Carbohydrates.Shapes.ConeLeft,
                Carbohydrates.Shapes.ConeRight,
              ] /* Divided cone */,
              axisUp: [0, 1, 0],
              instances: [
                {
          ...
          var mappedData = (function() {
            ...
            var _loop_2 = function(shape) {
              var _loop_3 = function(instance) {
                var entry = function(name, elem) {
                  return map.set(name, {
                    instanceName: instance.name,
                    name: name,
                    color: elem.colorB
                      ? [
                          LiteMol.Visualization.Color.fromHexString(
                            elem.colorA,
                          ),
                          LiteMol.Visualization.Color.fromHexString(
                            elem.colorB,
                ...
                for (
                  var _i = 0, _a = instance.common.names;
                  _i < _a.length;
                  _i++
                ) {
                  var name_1 = _a[_i];
  ...
  (function(Extensions) {
    ...
    (function(ComplexReprensetation) {
      ...
      (function(Carbohydrates) {
        ...
        Carbohydrates.DefaultFullParams = {
          type: 'Full',
          fullSize: 'Large',
          linkColor: LiteMol.Visualization.Color.fromRgb(
            255 * 0.6,
            255 * 0.6,
            255 * 0.6,
          ),
          showTerminalLinks: true,
          showTerminalAtoms: false,
        };
        function isRepresentable(model, residueIndices) {
          var name = model.data.residues.name;
          for (
            var _c = 0, residueIndices_1 = residueIndices;
            _c < residueIndices_1.length;
            _c++
          ) {
        ...
        (function(Transforms) {
          var _this = this;
          Transforms.CarbohydratesInfo = Entity.create({
            name: 'Carbohydrate Information',
            typeClass: 'Object',
            shortName: 'CI',
          ...
          Transforms.CreateInfo = Tree.Transformer.create(
            ...
            function(ctx, a, t) {
              return LiteMol.Bootstrap.Task.resolve(
                'Carbohydrates',
                'Silent',
                Transforms.CarbohydratesInfo.create(t, {
                  label: 'Carbohydrates',
                  info: t.params.info,
                }),
              );
          ...
          Transforms.CreateVisual = Tree.Transformer.create(
            {
              ...
              name: '3D-SNFG',
              description:
                'Create carbohydrate representation using 3D-SNFG shapes.',
              from: [Transforms.CarbohydratesInfo],
              to: [Entity.Molecule.Visual],
              isUpdatable: true,
              defaultParams: function() {
                return Carbohydrates.DefaultFullParams;
              },
            },
            function(ctx, a, t) {
              return LiteMol.Bootstrap.Task.create(
                    ...
                    return __generator(this, function(_h) {
                      switch (_h.label) {
                        case 0:
                          ...
                          if (!model)
                            throw Error(
                              'Carbohydrate representation requires a Molecule.Model entity ancestor.',
                            );
                          (_c = getRepresentation(
                            model.props.model,
                            a.props.info,
                            t.params,
                          )),
                            ...
                            (tag = _c.tags),
                            (mapper = _c.mapper);
                          _e = (_d = LiteMol.Visualization.Surface.Model)
                            .create;
                          _f = [a];
                          _g = {};
                            ...
                            _e
                              .apply(
                                ...
                                _f.concat([
                                  ((_g.surface = _h.sent()),
                                  (_g.theme = theme),
                                  (_g.parameters = { mapPickElements: mapper }),
                                  _g),
                                ]),
                              )
                              .run(ctx),
                        ...
                        case 2:
                          ...
                          return [
                            2 /*return*/,
                            LiteMol.Bootstrap.Entity.Molecule.Visual.create(t, {
                              label: '3D-SNFG',
                              model: visual,
                              style: style,
                              isSelectable: true,
            ...
            function(ctx, b, t) {
              ...
              var colorMapping = LiteMol.Visualization.Theme.createColorMapMapping(
                function(i) {
                  return i;
                },
                colors,
                t.params.type === 'Full'
                  ? t.params.linkColor
                  : LiteMol.Visualization.Color.fromHexString('#666666'),
              );
              var theme = LiteMol.Visualization.Theme.createMapping(
                colorMapping,
              );
              b.props.model.applyTheme(theme);
              return LiteMol.Bootstrap.Task.resolve(
                t.transformer.info.name,
                'Background',
                Tree.Node.Null,
              );
            },
          ...
          (Transforms =
            Carbohydrates.Transforms || (Carbohydrates.Transforms = {})),
        );
        function EmptyInfo(warnings) {
          return {
            links: [],
            map: LiteMol.Core.Utils.FastMap.create(),
            entries: [],
            carbohydrateIndices: [],
            terminalIndices: [],
            warnings: warnings,
        ...
        function getInfo(params) {
          var model = params.model,
            ...
            atomMask = params.atomMask,
            bonds = params.bonds;
          var _c = getRepresentableResidues(model, fragment.residueIndices),
            carbohydrateIndices = _c.residueIndices,
            entries = _c.entries,
          ...
          var _d = findLinks({
            ...
            links = _d.links,
            terminalIndices = _d.terminalIndices;
          return {
            links: links,
            map: map,
            entries: entries,
            carbohydrateIndices: carbohydrateIndices,
        ...
        function getRepresentation(model, info, params) {
          var carbohydrateIndices = info.carbohydrateIndices,
          ...
          var scale =
            params.type === 'Full'
              ? params.fullSize === 'Small'
                ? 0.55
                : params.fullSize === 'Medium' ? 0.75 : 1.1
              : params.iconScale;
          var id = 0;
          for (var i = 0; i < carbohydrateIndices.length; i++) {
            var representation = entries[i].representation;
            var ts = Carbohydrates.Shapes.makeTransform(
              model,
              entries[i],
              scale,
              params.type,
            ...
            for (var _c = 0, _d = representation.shape; _c < _d.length; _c++) {
              ...
              tags.set(id, {
                type: 'Residue',
                instanceName: representation.instanceName,
                residueIndex: carbohydrateIndices[i],
                model: model,
              });
              shapes.add(
                __assign({ type: 'Surface', surface: surface, id: id++ }, ts),
              );
            }
          }
          if (params.type === 'Full') {
            var showTerminalLinks = params.showTerminalLinks,
              showTerminalAtoms = params.showTerminalAtoms;
            var linkRadius =
              params.fullSize === 'Small'
                ? 0.12
                : params.fullSize === 'Medium' ? 0.2 : 0.28;
              ...
              switch (link.type) {
                ...
                case 'Terminal': {
                  ...
                  if (showTerminalAtoms) {
                    ...
                    shapes.add({
                      type: 'Surface',
                      surface: Carbohydrates.Shapes.Sphere,
                      id: id++,
                      scale: [atomRadius, atomRadius, atomRadius],
                      translation: b,
                    });
                  }
                  break;
        ...
        function createElementMapper(model, tags) {
          var _c = model.data.residues,
            atomStartIndex = _c.atomStartIndex,
            atomEndIndex = _c.atomEndIndex;
          return function(pickId) {
            ...
            if (tag.type !== 'Link') {
              for (
                var i = atomStartIndex[tag.residueIndex],
                  _i = atomEndIndex[tag.residueIndex];
                i < _i;
                i++
              )
                ret.push(i);
              ...
              var rI = tag.link.rA;
              for (
                var i = atomStartIndex[rI], _i = atomEndIndex[rI];
                i < _i;
                i++
              )
                ret.push(i);
        ...
        function findLinks(params) {
          var model = params.model,
            bonds = params.bonds,
            atomMask = params.atomMask,
            carbohydrateMap = params.carbohydrateMap,
            entries = params.entries;
          var atomAIndex = bonds.atomAIndex,
            atomBIndex = bonds.atomBIndex,
            type = bonds.type;
          var residueIndex = model.data.atoms.residueIndex;
          var _c = model.positions,
            x = _c.x,
            y = _c.y,
            z = _c.z;
          ...
          for (var i = 0, _ic = bonds.count; i < _ic; i++) {
            ...
            var a = Math.min(_a, _b),
              b = Math.max(_a, _b);
            var rA = residueIndex[a],
              rB = residueIndex[b];
            var hasA = carbohydrateMap.has(rA),
              hasB = carbohydrateMap.has(rB);
            var bondType = type[i];
            if (hasA && hasB) {
              if (rA === rB) continue;
              var key = rA + ' ' + rB;
              ...
              var e1 = entries[carbohydrateMap.get(rA)],
                e2 = entries[carbohydrateMap.get(rB)];
              var link = {
                type: 'Carbohydrate',
                rA: rA,
                rB: rB,
                atomA: a,
                atomB: b,
                centerA: e1.ringCenter,
                centerB: e2.ringCenter,
                bondType: bondType,
              };
              links.push(link);
              e1.links.push(link);
              ...
              var link = {
                ...
                atomB: b,
                centerA: e1.ringCenter,
                centerB: LA.Vector3(x[b], y[b], z[b]),
                bondType: bondType,
              };
              links.push(link);
              ...
              var link = {
                ...
                atomA: b,
                atomB: a,
                centerA: e2.ringCenter,
                centerB: LA.Vector3(x[a], y[a], z[a]),
                bondType: bondType,
              };
              links.push(link);
        ...
        function warn(model, rI) {
          return (
            "Residue '" +
            Carbohydrates.formatResidueName(model, rI) +
            "' has a recognized carbohydrate name, but is missing ring atoms with standard names."
          );
        }
        function isRing(model, atoms, ringCenter) {
          var ringRadius = LiteMol.Bootstrap.Utils.Molecule.getCentroidAndRadius(
            model,
            atoms,
            ringCenter,
          );
          if (ringRadius > 1.95) return 0;
          var u = LA.Vector3.zero(),
            v = LA.Vector3.zero();
          var _c = model.positions,
            x = _c.x,
            y = _c.y,
        ...
        function getRepresentableResidues(model, sourceResidueIndices) {
          ...
          var residueIndices = [],
            ...
            warnings = [];
          for (
            var _c = 0, sourceResidueIndices_1 = sourceResidueIndices;
            _c < sourceResidueIndices_1.length;
            _c++
          ) {
            ...
            var added = false;
            for (
              var _d = 0, possibleRingAtoms_1 = possibleRingAtoms;
              _d < possibleRingAtoms_1.length;
              _d++
            ) {
              ...
              entries.push({
                representation: Carbohydrates.Mapping.getResidueRepresentation(
                  name[rI],
                ),
                ringAtoms: ringAtoms,
        ...
        function getRingAtoms(model, rI) {
          ...
          var ret = [];
          for (
            var _d = 0, _e = Carbohydrates.Mapping.RingNames;
            _d < _e.length;
            _d++
          ) {
            var names = _e[_d];
            var atoms = [];
            var found = 0;
            for (var i = 0; i < names.__len; i++) atoms.push(0);
            for (
              var aI = atomStartIndex[rI], _b = atomEndIndex[rI];
              aI < _b;
              aI++
            ) {
      ...
      (function(Carbohydrates) {
        ...
        function HighlightCustomElementsBehaviour(context) {
          context.highlight.addProvider(function(info) {
            ...
            var repr = Carbohydrates.Mapping.getResidueRepresentation(
              data.residues[0].name,
            );
  ...
  (function(Extensions) {
    ...
    (function(ComplexReprensetation) {
      ...
      function createComplexRepresentation(computation, model, queryCtx) {
        return __awaiter(this, void 0, void 0, function() {
          var sequenceAtoms,
            ...
            ret_2,
            waterAtoms,
            possibleHetGroupsAndInteractingSequenceQ,
            possibleHetGroupsAndInteractingSequence,
            ret_3,
            bonds,
            _a,
            entityIndex,
            ...
            aI,
            rI,
            hetGroupsWithSequence,
            carbohydrates,
            commonAtoms,
            carbMap,
            _d,
            hetGroupsWithSequence_1,
            aI,
            rI,
            interactingSequenceAtoms,
            _e,
            hetGroupsWithSequence_2,
            aI,
            rI,
            ret;
          return __generator(this, function(_f) {
            switch (_f.label) {
              case 0:
                return [
                  4 /*yield*/,
                  computation.updateProgress(
                    'Determing main sequence atoms...',
                  ),
                ];
              case 1:
                _f.sent();
                ...
                if (sequenceAtoms.length === queryCtx.atomCount && !hasModRes) {
                  ret_1 = {
                    ...
                    het: {
                      other: [],
                      carbohydrates: ComplexReprensetation.Carbohydrates.EmptyInfo(
                        [],
                      ),
                    },
                    freeWaterAtoms: [],
                ...
                waterAtoms = Q.entities({ type: 'water' })
                  .union()
                  .compile()(queryCtx)
                  .unionAtomIndices();
                possibleHetGroupsAndInteractingSequenceQ = Q.or(
                  Q.atomsFromIndices(waterAtoms),
                  Q.atomsFromIndices(sequenceAtoms),
                )
                  .complement()
                  .ambientResidues(getMaxInteractionRadius(model))
                  .union()
                  .compile();
                possibleHetGroupsAndInteractingSequence = possibleHetGroupsAndInteractingSequenceQ(
                  queryCtx,
                ).fragments[0];
                // is everything cartoon?
                if (!possibleHetGroupsAndInteractingSequence) {
                  ret_3 = {
                    ...
                    freeWaterAtoms: waterAtoms,
                  };
                  return [2 /*return*/, ret_3];
                }
                return [
                  4 /*yield*/,
                  computation.updateProgress('Computing bonds...'),
                ];
              case 2:
                _f.sent();
                bonds = S.computeBonds(
                  model,
                  possibleHetGroupsAndInteractingSequence.atomIndices,
                );
                (_a = model.data.atoms),
                  (entityIndex = _a.entityIndex),
                  (residueIndex = _a.residueIndex);
                entType = model.data.entities.type;
                (atomAIndex = bonds.atomAIndex),
                  (atomBIndex = bonds.atomBIndex);
                /////////////////////////////////////////////////////
                // WATERS
                return [
                  4 /*yield*/,
                  computation.updateProgress('Identifying free waters...'),
                ];
              case 3:
                /////////////////////////////////////////////////////
                // WATERS
                ...
                for (i = 0, __i = bonds.count; i < __i; i++) {
                  ...
                  (tA = entType[entityIndex[a]]),
                    (tB = entType[entityIndex[b]]);
                  if (tA === 'water') {
                ...
                freeWaterAtoms = new Int32Array(
                  waterAtoms.length - boundWaters.size,
                );
                waterAtomsOffset = 0;
                for (
                  _i = 0, waterAtoms_1 = waterAtoms;
                  _i < waterAtoms_1.length;
                  _i++
                ) {
                  aI = waterAtoms_1[_i];
                ...
                return [
                  4 /*yield*/,
                  computation.updateProgress('Identifying HET groups...'),
                ];
              case 4:
                /////////////////////////////////////////////////////
                // HET GROUPS with SEQUENCE RESIDUES
                ...
                _hetGroupsWithSequence = CU.ChunkedArray.forInt32(
                  possibleHetGroupsAndInteractingSequence.atomCount / 2,
                );
                (boundSequence = CU.FastSet.create()),
                  (boundHetAtoms = CU.FastSet.create());
                for (i = 0, __i = bonds.count; i < __i; i++) {
                  (a = atomAIndex[i]), (b = atomBIndex[i]);
                ...
                for (
                  _b = 0,
                    _c = possibleHetGroupsAndInteractingSequence.atomIndices;
                  _b < _c.length;
                  _b++
                ) {
                  aI = _c[_b];
                  ...
                  if (
                    entType[entityIndex[aI]] === 'water' &&
                    !boundWaters.has(rI)
                  )
                    continue;
                  CU.ChunkedArray.add(_hetGroupsWithSequence, aI);
                }
                hetGroupsWithSequence = CU.ChunkedArray.compact(
                  _hetGroupsWithSequence,
                );
                /////////////////////////////////////////////////////
                // CARBS
                return [
                  4 /*yield*/,
                  computation.updateProgress('Identifying carbohydrates...'),
                ];
              case 5:
                /////////////////////////////////////////////////////
                // CARBS
                _f.sent();
                carbohydrates = ComplexReprensetation.Carbohydrates.getInfo({
                  model: model,
                  fragment: Q.Fragment.ofArray(
                    queryCtx,
                    hetGroupsWithSequence[0],
                    hetGroupsWithSequence,
                  ),
                  atomMask: queryCtx.mask,
                  bonds: bonds,
                });
                /////////////////////////////////////////////////////
                // OTHER HET GROUPS
                return [
                  4 /*yield*/,
                  computation.updateProgress(
                    'Identifying non-carbohydrate HET groups...',
                  ),
                ];
              case 6:
                /////////////////////////////////////////////////////
                // OTHER HET GROUPS
                _f.sent();
                commonAtoms = CU.ChunkedArray.forInt32(
                  hetGroupsWithSequence.length,
                );
                carbMap = carbohydrates.map;
                for (
                  _d = 0, hetGroupsWithSequence_1 = hetGroupsWithSequence;
                  _d < hetGroupsWithSequence_1.length;
                  _d++
                ) {
                ...
                return [
                  4 /*yield*/,
                  computation.updateProgress(
                    'Identifying interacting sequence residues...',
                  ),
                ];
              case 7:
                /////////////////////////////////////////////////////
                // INTERACTING SEQUENCE
                _f.sent();
                interactingSequenceAtoms = CU.ChunkedArray.forInt32(
                  hetGroupsWithSequence.length,
                );
                for (
                  _e = 0, hetGroupsWithSequence_2 = hetGroupsWithSequence;
                  _e < hetGroupsWithSequence_2.length;
                  _e++
                ) {
                  aI = hetGroupsWithSequence_2[_e];
                  rI = residueIndex[aI];
                  if (
                    boundSequence.has(rI) ||
                    (boundHetAtoms.has(aI) && !carbMap.has(rI))
                  )
                ...
                ret = {
                  sequence: {
                    all: sequenceAtoms,
                    interacting: CU.ChunkedArray.compact(
                      interactingSequenceAtoms,
                    ),
                    modified: modifiedSequence,
                  },
                  het: {
                    other: CU.ChunkedArray.compact(commonAtoms),
      ...
      function getModRes(model, ctx) {
        ...
        var asymId = modRes.asymId,
          seqNumber = modRes.seqNumber,
          insCode = modRes.insCode;
        var residues = [];
        for (var i = 0, __i = modRes.count; i < __i; i++) {
          residues.push({
            asymId: asymId[i],
            seqNumber: seqNumber[i],
            insCode: insCode[i],
          });
        }
      ...
      function getMaxInteractionRadius(model) {
        ...
        if (model.data.bonds.structConn) {
          for (
            var _i = 0, _a = model.data.bonds.structConn.entries;
            _i < _a.length;
            _i++
          ) {
            var c = _a[_i];
      ...
      function chainLengthAndType(model, cI, mask) {
        ...
        var _b = model.data.residues,
          ...
          ssi = _b.secondaryStructureIndex;
        var length = 0;
        var isAmk = false,
          isNucleotide = false;
        for (
          var rI = residueStartIndex[cI], __b = residueEndIndex[cI];
          rI < __b;
          rI++
        ) {
          ...
          for (
            var aI = atomStartIndex[rI], __i = atomEndIndex[rI];
            aI < __i;
            aI++
          ) {
            if (mask.has(aI)) {
      ...
      function findMainSequence(model, queryCtx) {
        ...
        for (var _i = 0, _c = model.data.chains.indices; _i < _c.length; _i++) {
          var cI = _c[_i];
          var _d = chainLengthAndType(model, cI, mask),
            length_1 = _d.length,
            isAmk = _d.isAmk,
            isNucleotide = _d.isNucleotide;
          if (
            (isAmk && length_1 <= MAX_AMINO_SEQ_LIGAND_LENGTH) ||
            (isNucleotide && length_1 <= MAX_NUCLEOTIDE_SEQ_LIGAND_LENGTH)
          )
            continue;
          for (
            var rI = residueStartIndex[cI], __b = residueEndIndex[cI];
      ...
      function isCartoonLike(model, mask, rI) {
        var _a = model.data,
          secondaryStructure = _a.secondaryStructure,
          residues = _a.residues,
          atoms = _a.atoms;
        var atomStartIndex = residues.atomStartIndex,
          atomEndIndex = residues.atomEndIndex,
          ssi = residues.secondaryStructureIndex;
        var ss = secondaryStructure[ssi[rI]].type;
        if (ss === 0 /* None */) return false;
        var name = atoms.name;
        if (ss === 5 /* Strand */) {
          return _isCartoonLike(
            mask,
            atomStartIndex[rI],
            atomEndIndex[rI],
            name,
  ...
  (function(Extensions) {
    ...
    (function(ComplexReprensetation) {
      ...
      (function(Transforms) {
        ...
        Transforms.ComplexInfo = Entity.create({
          name: 'Macromolecular Complex Info',
          typeClass: 'Object',
          shortName: 'MC',
          description: 'Information about a macromolecular complex.',
        });
        Transforms.CreateComplexInfo = Tree.Transformer.create(
          {
            ...
            name: 'Complex Info',
            description:
              'Information about macromolecular complex (Main sequence, ligands, etc.).',
          ...
          function(ctx, a, t) {
            return LiteMol.Bootstrap.Task.create('Complex', 'Normal', function(
              ctx,
            ) {
              return __awaiter(_this, void 0, void 0, function() {
                ...
                return __generator(this, function(_a) {
                  switch (_a.label) {
                    case 0:
                      model = LiteMol.Bootstrap.Utils.Molecule.findModel(a);
                      queryCtx = LiteMol.Bootstrap.Utils.Molecule.findQueryContext(
                        a,
                      );
                      return [
                        4 /*yield*/,
                        ComplexReprensetation.createComplexRepresentation(
                          ctx,
                          model.props.model,
                          queryCtx,
                        ),
                    ...
                    case 1:
                      ...
                      return [
                        2 /*return*/,
                        Transforms.ComplexInfo.create(t, {
                          label: 'Complex',
                          info: info,
                        }),
                      ];
        ...
        Transforms.CreateVisual = Tree.Transformer.actionWithContext(
          ...
          function(context, a, t) {
            ...
            if (info.sequence.all.length) {
              ...
              sequence
                .then(
                  ...
                  {
                    query: Q.atomsFromIndices(info.sequence.all),
                    name: 'All Residues',
                    silent: true,
                  },
                  { isBinding: false },
                ...
                theme: {
                  template:
                    LiteMol.Bootstrap.Visualization.Molecule.Default
                      .CartoonThemeTemplate,
                  colors:
                    LiteMol.Bootstrap.Visualization.Molecule.Default
                      .CartoonThemeTemplate.colors,
                  transparency: { alpha: 1.0 },
                },
              };
              if (info.sequence.interacting.length) {
                sequence
                  .then(
                    Transformer.Molecule.CreateSelectionFromQuery,
                    {
                      query: Q.atomsFromIndices(info.sequence.interacting),
                      name: 'Interacting Residues',
                      silent: true,
                    },
                    { isBinding: false },
                  )
                  .then(Transformer.Molecule.CreateVisual, {
                    style: sequenceBSStyle,
                  });
              }
              if (info.sequence.modified.length) {
                sequence
                  .then(
                    Transformer.Molecule.CreateSelectionFromQuery,
                    {
                      query: Q.atomsFromIndices(info.sequence.modified),
            ...
            if (
              info.het.other.length ||
              info.het.carbohydrates.entries.length
            ) {
              var hetGroups = action.add(
                a,
                Transformer.Basic.CreateGroup,
                { label: 'HET', description: '' },
                { isBinding: false },
              );
              if (info.het.other.length) {
                hetGroups
                  .then(Transformer.Molecule.CreateSelectionFromQuery, {
                    query: Q.atomsFromIndices(info.het.other),
                    name: 'Ligands',
                    silent: true,
                  })
                  .then(
              ...
              if (info.het.carbohydrates.entries.length) {
                var shadeStyle = {
                  ...
                  theme: {
                    template:
                      LiteMol.Bootstrap.Visualization.Molecule.Default
                        .ElementSymbolThemeTemplate,
                    colors:
                      LiteMol.Bootstrap.Visualization.Molecule.Default
                        .ElementSymbolThemeTemplate.colors,
                    transparency: { alpha: 0.15 },
                  },
                };
                var carbsQ = Q.or(
                  Q.residuesFromIndices(
                    info.het.carbohydrates.carbohydrateIndices,
                  ),
                  Q.residuesFromIndices(info.het.carbohydrates.terminalIndices),
                ).union();
                var carbs = hetGroups.then(
                  LiteMol.Bootstrap.Entity.Transformer.Molecule
                    .CreateSelectionFromQuery,
                  { query: carbsQ, name: 'Std. Carbohydrates', silent: true },
                  {},
                );
                carbs.then(
                ...
                carbs
                  .then(
                    ComplexReprensetation.Carbohydrates.Transforms.CreateInfo,
                    { info: info.het.carbohydrates },
                  )
                  .then(
                    ComplexReprensetation.Carbohydrates.Transforms.CreateVisual,
                    ComplexReprensetation.Carbohydrates.DefaultFullParams,
                    { isBinding: true },
                  );
              }
            }
            if (info.freeWaterAtoms.length) {
              ...
              action
                .add(
                  ...
                  Transformer.Molecule.CreateSelectionFromQuery,
                  {
                    query: Q.atomsFromIndices(info.freeWaterAtoms),
                    name: 'Unbound Water',
                    silent: true,
                  },
                  { isBinding: true },
            ...
            return {
              action: action,
              context: { warnings: info.het.carbohydrates.warnings },
            };
          },
          function(context, ws) {
            if (!ws) return;
        ...
        function CreateRepresentationWhenModelIsAddedBehaviour(context) {
          LiteMol.Bootstrap.Event.Tree.NodeAdded.getStream(context).subscribe(
            function(e) {
              if (
                Transforms.SuppressCreateVisualWhenModelIsAdded ||
                !LiteMol.Bootstrap.Tree.Node.is(
                  e.data,
                  LiteMol.Bootstrap.Entity.Molecule.Model,
                ) ||
                e.data.isHidden
              ) {
                return;
              ...
              LiteMol.Bootstrap.Tree.Transform.apply(context, action)
                .run()
                .then(function() {
                  LiteMol.Bootstrap.Command.Visual.ResetScene.dispatch(
                    context,
                    void 0,
                  );
                });
        ...
        (Transforms =
          ComplexReprensetation.Transforms ||
          (ComplexReprensetation.Transforms = {})),
      );
    })(
      (ComplexReprensetation =
          ...
          var CreateVisual = /** @class */ (function(_super) {
            ...
            CreateVisual.prototype.updateVisual = function(newParams) {
              ...
              this.autoUpdateParams(
                __assign(
                  ...
                  type === 'Full'
                    ? Carbohydrates.DefaultFullParams
                    : Carbohydrates.DefaultIconsParams,
                  p,
                  newParams,
                ),
              );
            ...
            CreateVisual.prototype.renderControls = function() {
              ...
              return React.createElement(
                ...
                React.createElement(Controls.Toggle, {
                  onChange: function(v) {
                    return _this.updateVisual({ type: v ? 'Full' : 'Icons' });
                  },
                  value: params.type === 'Full',
                  label: 'Links',
                }),
                params.type === 'Full'
                  ? React.createElement(Controls.OptionsGroup, {
                      options: Carbohydrates.FullSizes,
                      caption: function(s) {
                        return s;
                      },
                      current: params.fullSize,
                      onChange: function(fullSize) {
                        return _this.updateVisual({ fullSize: fullSize });
                      },
                      label: 'Size',
                    })
                  : React.createElement(Controls.Slider, {
                      ...
                      onChange: function(scale) {
                        return _this.updateVisual({ iconScale: scale });
                      },
                      min: 0.5,
                      max: 1.1,
                      step: 0.01,
                      value: params.iconScale,
                    }),
                params.type === 'Full'
                  ? React.createElement(Controls.ToggleColorPicker, {
                      label: 'Link Color',
                      color: params.linkColor,
                      onChange: function(linkColor) {
                        return _this.updateVisual({ linkColor: linkColor });
                      },
                    })
                  : void 0,
                params.type === 'Full'
                  ? React.createElement(Controls.Toggle, {
                      onChange: function(showTerminalLinks) {
                        return _this.updateVisual({
                          showTerminalLinks: showTerminalLinks,
                        });
                      },
                      value: params.showTerminalLinks,
                      label: 'Terminal Links',
                      title: 'Show/hide link to non-carbohydrate residues',
                    })
                  : void 0,
                params.type === 'Full'
                  ? React.createElement(Controls.Toggle, {
                      onChange: function(showTerminalAtoms) {
                        return _this.updateVisual({
                          showTerminalAtoms: showTerminalAtoms,
                        });
                      },
                      value: params.showTerminalAtoms,
                      label: 'Terminal Pegs',
                      title: 'Show/hide terminal residues as spheres',
                    })
                  : void 0,
              );
            };
...
(function(LiteMol) {
  ...
  (function(Extensions) {
    ...
    (function(ParticleColoring) {
      ...
      var Tree = LiteMol.Bootstrap.Tree;
      var Entity = LiteMol.Bootstrap.Entity;
      ParticleColoring.Coloring = Entity.create({
        name: 'Particle Coloring',
        typeClass: 'Object',
        shortName: 'PC',
        description:
          "Atom coloring based on distance from the molecule' centroid.",
      });
      ParticleColoring.Apply = Tree.Transformer.create(
        {
          ...
          name: 'Particle Coloring',
          description:
            "Apply atom coloring based on distance from the molecule' centroid.",
          from: [Entity.Molecule.Visual],
          to: [ParticleColoring.Coloring],
          isUpdatable: true,
          defaultParams: function() {
            return { min: 0, max: 1e10, steps: 66, opacity: 1.0 };
          },
        },
        function(context, a, t) {
          return LiteMol.Bootstrap.Task.create('Complex', 'Normal', function(
            ...
            return __awaiter(_this, void 0, void 0, function() {
              ...
              return __generator(this, function(_a) {
                ...
                coloring = ParticleColoring.Coloring.create(t, {
                  info: info,
                  label: 'Particle Coloring',
                  description:
                    Math.round(10 * t.params.min) / 10 +
                    ' - ' +
                    Math.round(10 * t.params.max) / 10,
                });
      ...
      function getAtomParticleDistances(model) {
        var _a = model.positions,
          ...
          count = _a.count;
        var center = Vec3();
        LiteMol.Bootstrap.Utils.Molecule.getCentroidAndRadius(
          model,
          model.data.atoms.indices,
          center,
        );
      ...
      function makeRainbow(steps) {
        ...
        for (var i = steps - 1; i >= 0; i--) {
          ...
          var low = Math.floor(t),
            high = Math.min(Math.ceil(t), pal.length - 1);
          var color = LiteMol.Visualization.Color.fromRgb(0, 0, 0);
          LiteMol.Visualization.Color.interpolate(
            pal[low],
            pal[high],
            t - low,
            color,
      ...
      function applyTheme(ctx, coloring, visual, _a) {
        ...
        var atomMapping = createColorMapping(
          distInfo.distances,
          Math.max(min, distInfo.min),
          Math.min(max, distInfo.max),
          steps - 1,
        );
        var rainbow = makeRainbow(steps);
        var mapping = LiteMol.Visualization.Theme.createPalleteIndexMapping(
          function(i) {
            return atomMapping[i];
          },
          rainbow,
        );
        var theme = LiteMol.Visualization.Theme.createMapping(mapping, {
          transparency: { alpha: alpha },
          isSticky: true,
        });
        LiteMol.Bootstrap.Command.Visual.UpdateBasicTheme.dispatch(ctx, {
          visual: visual,
          theme: theme,
        });
      }
      ...
      (ParticleColoring =
        Extensions.ParticleColoring || (Extensions.ParticleColoring = {})),
    );
  })((Extensions = LiteMol.Extensions || (LiteMol.Extensions = {})));
})(LiteMol || (LiteMol = {}));
/*
        ...
        var Apply = /** @class */ (function(_super) {
          ...
          Apply.prototype.rainbow = function() {
            var grad =
              ...
              LiteMol.Bootstrap.Visualization.Molecule.RainbowPalette.map(
                function(c) {
                  return (
            ...
            return React.createElement('div', {
              style: { background: grad, height: '8px', marginTop: '1px' },
            });
          };
          Apply.prototype.renderControls = function() {
            var _this = this;
            var params = this.params;
            if (!this.isUpdate) return React.createElement('div', null);
            ...
            return React.createElement(
              ...
              React.createElement(Controls.Slider, {
                ...
                onChange: function(min) {
                  return _this.autoUpdateParams({ min: min });
                },
                min: min,
                max: max,
                step: 0.1,
                value: Math.max(params.min, min),
              }),
              React.createElement(Controls.Slider, {
                label: 'High Radius',
                onChange: function(max) {
                  return _this.autoUpdateParams({ max: max });
                },
                min: params.min,
                max: max,
                step: 0.1,
                value: Math.min(params.max, max),
              }),
              React.createElement(Controls.Slider, {
                label: 'Opacity',
                onChange: function(opacity) {
                  return _this.autoUpdateParams({ opacity: opacity });
                },
                min: 0,
                max: 1,
                step: 0.01,
        ...
        CreateLoopAnnotationView.prototype.renderControls = function() {
          ...
          return React.createElement(
            ...
            React.createElement(Controls.TextBoxGroup, {
              ...
              label: 'Server',
              title: 'The base URL of the annotation API.',
              onEnter: function(e) {
                return _this.applyEnter(e);
              },
...
(function(LiteMol) {
  ...
  (function(Extensions) {
    ...
    (function(RNALoops) {
      ...
      var Entity = LiteMol.Bootstrap.Entity;
      var Transformer = LiteMol.Bootstrap.Entity.Transformer;
      RNALoops.LoopAnnotation = Entity.create({
        name: 'BGSU RNA Loops',
        typeClass: 'Behaviour',
        shortName: 'RL',
        description: 'Represents BGSU loop annotation.',
      });
      var Api;
      (function(Api) {
        function parseCSV(data) {
          ...
          for (var i = 0; i < lines.length; i++) {
            ...
            var type = id[0] + id[1];
            var residueIds = line
              .substring(comma + 2, line.length - 1)
              .split(',');
            var residues = [];
        ...
        function create(entries) {
          ...
          for (var _i = 0, entries_1 = entries; _i < entries_1.length; _i++) {
            ...
            for (var _a = 0, _c = entry.residues; _a < _c.length; _a++) {
              var residue = _c[_a];
              var model =
                annotation[residue.modelId] ||
                (annotation[residue.modelId] = {});
              var chain =
                model[residue.authAsymId] || (model[residue.authAsymId] = {});
              var seq =
                chain[residue.authSeqNumber] ||
                (chain[residue.authSeqNumber] = {});
      ...
      (function(Interactivity) {
        ...
        (Interactivity =
          RNALoops.Interactivity || (RNALoops.Interactivity = {})),
      );
      var Theme;
      (function(Theme) {
        var colorMap = (function() {
      ...
      var Create = LiteMol.Bootstrap.Tree.Transformer.create(
        ...
        function(context, a, t) {
          return LiteMol.Bootstrap.Task.create(
            'RNA Loop Annotation (' + t.params.id + ')',
            'Normal',
            function(ctx) {
              return __awaiter(_this, void 0, void 0, function() {
                ...
                return __generator(this, function(_a) {
                  switch (_a.label) {
                    ...
                    case 1:
                      ...
                      return [
                        2 /*return*/,
                        RNALoops.LoopAnnotation.create(t, {
                          label: 'RNA Loop Annotation',
                          behaviour: new Interactivity.Behaviour(
                            context,
                            annotation,
                          ),
      ...
      RNALoops.DownloadAndCreate = LiteMol.Bootstrap.Tree.Transformer.actionWithContext(
        {
          ...
          defaultParams: function(ctx) {
            return {
              server: ctx.settings.get('extensions.rnaLoops.defaultServer'),
            };
          },
        },
        function(context, a, t) {
          ...
          var reportRef =
            t.params.reportRef || LiteMol.Bootstrap.Utils.generateUUID();
          var action = LiteMol.Bootstrap.Tree.Transform.build()
            .add(a, Transformer.Data.Download, {
              url: t.params.server.replace('#id', id),
              type: 'String',
              id: id,
              description: 'Annotation Data',
              title: 'RNA Annotation',
            })
        ...
        function(ctx, actionCtx) {
          if (!actionCtx || !ctx.select(actionCtx.reportRef).length) {
            ctx.logger.error(
              'Failed to load BGSU RNA annotation. Possible causes: no annotation available, server is down, server does not support HTTPS (use http:// in LiteMol URL to fix).',
            );
            return;
          }
          ctx.logger.info(
      ...
      RNALoops.ApplyTheme = LiteMol.Bootstrap.Tree.Transformer.create(
        {
          ...
          name: 'Apply Coloring',
          description:
            'Colors RNA strands according to annotation of secondary structure loops.',
        ...
        Data.DownloadBinaryCIFFromCoordinateServer = Bootstrap.Tree.Transformer.action(
          {
            ...
            description:
              'Download full or cartoon representation of a PDB entry using the BinaryCIF format.',
            from: [Entity.Root],
            to: [Entity.Action],
            defaultParams: function(ctx) {
              return {
            ...
            validateParams: function(p) {
              return !p.id || !p.id.trim().length
                ? ['Enter Id']
                : !p.serverUrl || !p.serverUrl.trim().length
                  ? ['Enter CoordinateServer base URL']
                  : void 0;
            },
          },
          function(context, a, t) {
            ...
            var url =
              '' +
              t.params.serverUrl +
              (t.params.serverUrl[t.params.serverUrl.length - 1] === '/'
                ? ''
                : '/') +
              id +
              '/' +
              query +
              '?encoding=bcif&lowPrecisionCoords=' +
              (t.params.lowPrecisionCoords ? '1' : '0');
            return Bootstrap.Tree.Transform.build()
              .add(a, Entity.Transformer.Data.Download, {
                url: url,
                type: 'Binary',
                id: id,
                title: 'Molecule',
              ...
              .then(
                Entity.Transformer.Molecule.CreateFromData,
                {
              ...
              .then(
                Entity.Transformer.Molecule.CreateModel,
                { modelIndex: 0 },
                { isBinding: false },
              );
          },
    ...
    (function(PDBe) {
      ...
      (function(Data) {
        ...
        function doElectron(a, t, id) {
          ...
          var groupRef = t.props.ref
            ? t.props.ref
            : Bootstrap.Utils.generateUUID();
          var group = action.add(
            a,
            Transformer.Basic.CreateGroup,
            { label: id, description: 'Density' },
            { ref: groupRef },
          );
          ...
          var diff = group
            .then(Transformer.Data.Download, {
              url:
                'https://www.ebi.ac.uk/pdbe/coordinates/files/' +
                id +
                '_diff.ccp4',
              type: 'Binary',
              id: id,
          ...
          diff.then(Transformer.Density.CreateVisualBehaviour, {
            id: 'Fo-Fc(-ve)',
            isoSigmaMin: -5,
            isoSigmaMax: 0,
            minRadius: 0,
        ...
        function doEmdb(a, t, id, contourLevel) {
          ...
          action
            .add(a, Transformer.Data.Download, {
              url:
                'https://www.ebi.ac.uk/pdbe/static/files/em/maps/emd_' +
                id +
                '.map.gz',
              type: 'Binary',
              id: labelId,
        ...
        function fail(a, message) {
          return {
            action: Bootstrap.Tree.Transform.build().add(
              a,
              Transformer.Basic.Fail,
              { title: 'Density', message: message },
            ),
            context: void 0,
          };
        }
                    ...
                    if (e && e[0] && e[0].related_structures) {
                      ...
                      if (!emdb.length) {
                        return [
                          ...
                          fail(
                            a,
                            "No related EMDB entry found for '" + id + "'.",
                          ),
                        ];
                      }
              ...
              switch (_a.label) {
                case 0:
                  ...
                  return [
                    4 /*yield*/,
                    Bootstrap.Utils.ajaxGetString(
                      'https://www.ebi.ac.uk/pdbe/api/emdb/entry/map/EMD-' + id,
                      'EMDB API',
                    ).run(ctx),
                  ];
                case 1:
        ...
        Data.DownloadDensity = Bootstrap.Tree.Transformer.actionWithContext(
          ...
          function(ctx, actionCtx) {
            ...
            var _a = actionCtx,
              id = _a.id,
              refs = _a.refs,
              groupRef = _a.groupRef;
            var sel = ctx.select((_b = Tree.Selection).byRef.apply(_b, refs));
            if (sel.length === refs.length) {
              ctx.logger.message(
                'Density loaded, click on a residue or an atom to view the data.',
              );
            } else if (sel.length > 0) {
              ctx.logger.message(
                'Density partially loaded, click on a residue or an atom to view the data.',
              );
            } else {
    ...
    (function(PDBe) {
      ...
      (function(Validation) {
                ...
                for (var _e = 0, _f = chain.models; _e < _f.length; _e++) {
                  ...
                  for (var _g = 0, _h = model.residues; _g < _h.length; _g++) {
                    ...
                    var id = getResidueId(
                        ...
                        residue.author_insertion_code,
                      ),
                      entry = residues[id];
                    if (entry) {
                      entry.residues.push(residue);
                      entry.numIssues = Math.max(
                        entry.numIssues,
        ...
        (function(Interactivity) {
          var Behaviour = /** @class */ (function() {
            ...
            Behaviour.prototype.processInfo = function(info) {
              ...
              var e = Api.getEntry(
                this.report,
                i.modelId,
                r.chain.entity.entityId,
                r.chain.asymId,
                Api.getResidueId(r.seqNumber, r.insCode),
              );
              if (!e) return void 0;
              var label;
              if (e.residues.length === 1) {
                ...
                if (!vr.outlier_types.length) label += 'no issue';
                  ...
                  label +=
                    '<b>' + e.residues[0].outlier_types.join(', ') + '</b>';
                return label;
              } else {
                label = '';
                var index = 0;
          ...
          (Interactivity =
            Validation.Interactivity || (Validation.Interactivity = {})),
        );
        var Theme;
        (function(Theme) {
          var colorMap = (function() {
          ...
          function createResidueMapNormal(model, report) {
            ...
            for (var i = 0, _b = model.data.residues.count; i < _b; i++) {
              var entry = Api.getEntry(
                ...
                entityId[i],
                asymId[i],
                Api.getResidueId(seqNumber[i], insCode[i]),
              );
              if (entry) {
  ...
  (function(Viewer) {
    ...
    (function(PDBe) {
      ...
      (function(SequenceAnnotation) {
        ...
        SequenceAnnotation.Annotations = Entity.create({
          name: 'PDBe Sequence Annotations',
          typeClass: 'Data',
          shortName: 'SA',
          description: 'Represents PDBe sequence annotation data.',
        });
        SequenceAnnotation.Annotation = Entity.create(
          {
          ...
          { isSilent: true, isFocusable: true },
        );
        SequenceAnnotation.Behaviour = Entity.create({
        ...
        (function(Interactivity) {
          var Behaviour = /** @class */ (function() {
            function Behaviour(context) {
              ...
              this.__highlight = LiteMol.Core.Utils.debounce(function() {
            ...
            Behaviour.prototype.register = function(behaviour) {
              ...
              this.node = behaviour;
              this.subs.push(
                this.context.behaviours.currentEntity.subscribe(function(e) {
                  return _this.update(e);
                }),
              );
              this.subs.push(
                LiteMol.Bootstrap.Command.Entity.Highlight.getStream(
                  this.context,
                ).subscribe(function(e) {
                  if (e.data.entities.length === 1) {
                    var a = e.data.entities[0];
                    if (a.type !== SequenceAnnotation.Annotation) return;
                    _this.toHighlight = a;
              ...
              this.subs.push(
                LiteMol.Bootstrap.Command.Entity.Focus.getStream(
                  this.context,
                ).subscribe(function(e) {
                  if (e.data.length === 1) {
                    var a = e.data[0];
            ...
            Behaviour.prototype.resetTheme = function() {
              ...
              if (molecule) {
                LiteMol.Bootstrap.Command.Visual.ResetTheme.dispatch(
                  this.context,
                  {
                    selection: LiteMol.Bootstrap.Tree.Selection.byValue(
                      molecule,
                    ).subtree(),
                  },
                );
            ...
            Behaviour.prototype.highlight = function() {
              ...
              this.toHighlight = void 0;
              if (!e || e.type !== SequenceAnnotation.Annotation) return;
              var a = e;
            ...
            Behaviour.prototype.focus = function(a) {
              var molecule = this.molecule;
              if (!molecule) return;
              var model = this.context.select(
                LiteMol.Bootstrap.Tree.Selection.byValue(molecule)
                  .subtree()
                  .ofType(LiteMol.Bootstrap.Entity.Molecule.Model),
              )[0];
              if (!model) return;
              LiteMol.Bootstrap.Command.Molecule.FocusQuery.dispatch(
                this.context,
                { model: model, query: a.props.query },
              );
              LiteMol.Bootstrap.Command.Entity.SetCurrent.dispatch(
                this.context,
                a,
              );
            };
            Behaviour.prototype.apply = function(a) {
              var molecule = this.molecule;
              if (!molecule) return;
              var visuals = this.context.select(
                LiteMol.Bootstrap.Tree.Selection.byValue(molecule)
                  .subtree()
                  .ofType(LiteMol.Bootstrap.Entity.Molecule.Visual),
              );
              for (
                var _i = 0, visuals_4 = visuals;
                _i < visuals_4.length;
                _i++
              ) {
                var v = visuals_4[_i];
          ...
          (Interactivity =
            SequenceAnnotation.Interactivity ||
            (SequenceAnnotation.Interactivity = {})),
        );
        var Theme;
        (function(Theme) {
          ...
          var selectionColor =
            LiteMol.Visualization.Theme.Default.SelectionColor;
          var highlightColor =
            LiteMol.Visualization.Theme.Default.HighlightColor;
        ...
        function buildAnnotations(parent, id, data) {
          ...
          var _loop_4 = function(g) {
            var ans = data[g];
            if (!ans) return 'continue';
            var entries = Object.keys(ans).filter(function(a) {
              return Object.prototype.hasOwnProperty.call(ans, a);
            });
            if (!entries.length) return 'continue';
            var group = action.add(
              parent,
              Transformer.Basic.CreateGroup,
              { label: g, isCollapsed: true },
              { isBinding: true },
            );
            for (var _i = 0, entries_2 = entries; _i < entries_2.length; _i++) {
              var a = entries_2[_i];
              group.then(SequenceAnnotation.CreateSingle, {
                data: ans[a],
                id: a,
                color: baseColor,
              });
          ...
          for (
            var _i = 0, _a = ['Pfam', 'InterPro', 'CATH', 'SCOP', 'UniProt'];
            _i < _a.length;
            _i++
          ) {
            var g = _a[_i];
              ...
              function(ctx) {
                return __awaiter(_this, void 0, void 0, function() {
                  ...
                  return __generator(this, function(_a) {
                      ...
                      .apply(
                        ...
                        data.mappings.map(function(m) {
                          return Query.sequence(
                            ...
                            m.struct_asym_id,
                            {
                              seqNumber: m.start.residue_number,
                              insCode: getInsCode(
                                m.start.author_insertion_code,
                              ),
                            },
                            {
                              seqNumber: m.end.residue_number,
                              insCode: getInsCode(m.end.author_insertion_code),
                            },
                          );
                        }),
                      )
                    ...
                    return [
                      2 /*return*/,
                      SequenceAnnotation.Annotation.create(t, {
                        label: data.identifier,
                        description: t.params.id,
                        query: query,
                  ...
                  return __generator(this, function(_a) {
                    switch (_a.label) {
                      ...
                      case 1:
                        ...
                        return [
                          2 /*return*/,
                          SequenceAnnotation.Annotations.create(t, {
        ...
        var CreateBehaviour = LiteMol.Bootstrap.Tree.Transformer.create(
          ...
          function(context, a, t) {
            return LiteMol.Bootstrap.Task.resolve(
              'Sequence Annotations',
              'Background',
              SequenceAnnotation.Behaviour.create(t, {
                label: 'Sequence Annotations',
                behaviour: new Interactivity.Behaviour(context),
              }),
            );
          },
        );
        ...
        SequenceAnnotation.DownloadAndCreate = LiteMol.Bootstrap.Tree.Transformer.action(
          ...
          function(context, a, t) {
            ...
            return LiteMol.Bootstrap.Tree.Transform.build()
              .add(a, Transformer.Data.Download, {
                url: 'https://www.ebi.ac.uk/pdbe/api/mappings/' + id,
                type: 'String',
                id: id,
                description: 'Annotation Data',
                title: 'Annotation',
        ...
        (SequenceAnnotation =
          PDBe.SequenceAnnotation || (PDBe.SequenceAnnotation = {})),
      );
    })((PDBe = Viewer.PDBe || (Viewer.PDBe = {})));
  })((Viewer = LiteMol.Viewer || (LiteMol.Viewer = {})));
})(LiteMol || (LiteMol = {}));
  ...
  (function(Viewer) {
    ...
    (function(PDBe) {
      ...
      (function(Views) {
          ...
          CreateSequenceAnnotationView.prototype.renderControls = function() {
            ...
            return React.createElement(
              ...
              React.createElement(Controls.ToggleColorPicker, {
                ...
                color: params.color,
                onChange: function(c) {
                  return _this.controller.autoUpdateParams({ color: c });
                },
                position: 'below',
              }),
            );
        ...
        var DownloadBinaryCIFFromCoordinateServerView = /** @class */ (function(
          _super,
        ) {
          ...
          DownloadBinaryCIFFromCoordinateServerView.prototype.renderControls = function() {
            ...
            var params = this.params;
            var idField = React.createElement(Controls.TextBoxGroup, {
              value: params.id,
              onChange: function(v) {
                return _this.updateParams({ id: v });
              },
            ...
            var options = [
              React.createElement(Controls.OptionsGroup, {
                ...
                current: params.type,
                onChange: function(o) {
                  return _this.updateParams({ type: o });
                },
                label: 'Type',
                title:
                  'Determines whether to send all atoms or just atoms that are needed for the Cartoon representation.',
              }),
              React.createElement(Controls.Toggle, {
                onChange: function(v) {
                  return _this.updateParams({ lowPrecisionCoords: v });
                },
                value: params.lowPrecisionCoords,
                label: 'Low Precicion',
                title:
                  'If on, sends coordinates with 1 digit precision instead of 3. This saves up to 50% of data that need to be sent.',
              }),
              React.createElement(Controls.TextBoxGroup, {
                value: params.serverUrl,
                onChange: function(v) {
                  return _this.updateParams({ serverUrl: v });
                },
                label: 'Server',
            ...
            return React.createElement(Controls.ExpandableGroup, {
              ...
              expander: React.createElement(Controls.ControlGroupExpander, {
                ...
                onChange: function(e) {
                  return _this.setPersistentState('showDetails', e);
                },
              }),
              options: options,
              isExpanded: showDetails,
        ...
        var DownloadDensityView = /** @class */ (function(_super) {
          ...
          DownloadDensityView.prototype.updateId = function(newId) {
            ...
            if (!id || typeof id === 'string')
              ...
              id = LiteMol.Bootstrap.Utils.merge(
                id,
                ((_b = {}), (_b[params.sourceId] = newId), _b),
              );
          ...
          DownloadDensityView.prototype.renderControls = function() {
            ...
            return React.createElement(
              ...
              null,
              React.createElement(Controls.OptionsGroup, {
                options: PDBe.Data.DensitySources,
                caption: function(s) {
                  return PDBe.Data.DensitySourceLabels[s];
                },
                current: params.sourceId,
                onChange: function(o) {
                  return _this.updateParams({ sourceId: o });
                },
                label: 'Source',
    ...
    (function(Views) {
      ...
      var LoadExample = /** @class */ (function(_super) {
        ...
        LoadExample.prototype.renderControls = function() {
          ...
          return React.createElement(Controls.OptionsGroup, {
            options: Viewer.Examples.ExampleIds,
            caption: function(s) {
              return Viewer.Examples.ExampleMap[s].name;
            },
            current: exampleId,
            onChange: function(exampleId) {
              return _this.updateParams({ exampleId: exampleId });
            },
            label: 'Name',
          });
        };
      ...
      var ObtainDownload = /** @class */ (function(_super) {
        ...
        ObtainDownload.prototype.updateSourceParams = function(newSrc) {
          ...
          var newParams = {
            sources: __assign(
              ...
              params.sources,
              ((_a = {}),
              (_a[params.sourceKind] = __assign({}, src, newSrc)),
              _a),
            ),
          };
        ...
        ObtainDownload.prototype.coordServer = function(src) {
          ...
          var idField = React.createElement(Controls.TextBoxGroup, {
            value: params.id,
            onChange: function(v) {
              return _this.updateSourceParams({ id: v });
            },
            label: 'Id',
            onEnter: function(e) {
              return _this.applyEnter(e);
          ...
          var options = [
            React.createElement(Controls.OptionsGroup, {
              ...
              current: params.type,
              onChange: function(o) {
                return _this.updateSourceParams({ type: o });
              },
              label: 'Type',
              title:
                'Determines whether to send all atoms or just atoms that are needed for the Cartoon representation.',
            ...
            React.createElement(Controls.Toggle, {
              onChange: function(v) {
                return _this.updateSourceParams({ lowPrecisionCoords: v });
              },
              value: params.lowPrecisionCoords,
              label: 'Low Precicion',
              title:
            ...
            React.createElement(Controls.TextBoxGroup, {
              value: params.serverUrl,
              onChange: function(v) {
                return _this.updateSourceParams({ serverUrl: v });
              },
              label: 'Server',
              title: 'The base URL of the CoordinateServer.',
              onEnter: function(e) {
        ...
        ObtainDownload.prototype.PDBe = function(src) {
          ...
          return React.createElement(Controls.TextBoxGroup, {
            value: src.id,
            onChange: function(v) {
              return _this.updateSourceParams({ id: v });
            },
        ...
        ObtainDownload.prototype.url = function(src) {
          ...
          return [
            React.createElement(Controls.OptionsGroup, {
              options: LiteMol.Core.Formats.Molecule.SupportedFormats.All,
              caption: function(s) {
                return s.name;
              },
              current: src.format,
              onChange: function(o) {
                return _this.updateSourceParams({ format: o });
              },
              label: 'Format',
            }),
            React.createElement(Controls.TextBoxGroup, {
              value: src.url,
              onChange: function(v) {
                return _this.updateSourceParams({ url: v });
              },
              label: 'URL',
              onEnter: function(e) {
                return _this.applyEnter(e);
        ...
        ObtainDownload.prototype.file = function(src) {
          ...
          var extensions = LiteMol.Core.Formats.FormatInfo.formatFileFilters(
            LiteMol.Core.Formats.Molecule.SupportedFormats.All,
          );
          return React.createElement(
            'div',
            null,
            React.createElement(
              ...
              {
                className:
                  'lm-btn lm-btn-block lm-btn-action lm-loader-lm-btn-file',
                style: { marginTop: '1px' },
              },
              ...
              React.createElement('input', {
                ...
                onChange: function(evt) {
                  return _this.updateSourceParams({
        ...
        ObtainDownload.prototype.renderControls = function() {
          ...
          var src = params.sources[params.sourceKind];
          var options =
            params.sourceKind === 'CoordinateServer'
              ? this.coordServer(src)
              : params.sourceKind === 'PDBe Updated mmCIF'
                ? this.PDBe(src)
                : params.sourceKind === 'URL' ? this.url(src) : this.file(src);
          return React.createElement(
            'div',
            null,
            React.createElement(Controls.OptionsGroup, {
              options: Viewer.DataSources.ObtainDownloadSources,
              caption: function(s) {
                return s;
              },
              current: params.sourceKind,
              onChange: function(o) {
                return _this.updateParams({ sourceKind: o });
              },
              label: 'Source',
              title: 'Determines where to obtain the data.',
            }),
  ...
  (function(Viewer) {
    ...
    (function(Examples) {
      ...
      Examples.ExampleMap = {
        ...
        '5va1-cryo-em': {
          name:
            'Open Human Ether-a-go-go-Related K(+) Channel hERG + Cryo-EM Map',
      ...
      Examples.LoadExample = LiteMol.Bootstrap.Tree.Transformer.action(
        {
          ...
          defaultParams: function() {
            return { exampleId: Examples.ExampleIds[0] };
          },
        },
        function(context, a, t) {
          ...
          return LiteMol.Bootstrap.Tree.Transform.build().add(
            a,
            Transformer.Basic.Delay,
            { timeoutMs: delay },
          );
        },
      );
      ...
      function unsubscribeOnDelete(plugin, subProvider, ref, extraCall) {
        var sub = subProvider();
        var del = plugin.subscribe(
          LiteMol.Bootstrap.Event.Tree.NodeRemoved,
          function(e) {
      ...
      function Zika(plugin) {
        ...
        var molecule = plugin
          ...
          .add(plugin.root, Transformer.Data.Download, {
            url:
              'https://webchem.ncbr.muni.cz/CoordinateServer/5ire/full?encoding=bcif&lowPrecisionCoords=1',
            type: 'Binary',
            id: '5ire',
          })
          .then(
            ...
            { format: LiteMol.Core.Formats.Molecule.SupportedFormats.mmBCIF },
            { ref: 'molecule', isBinding: true },
          );
        plugin.applyTransform(molecule).then(function() {
          var model = plugin
            .createTransform()
            .add('molecule', Transformer.Molecule.CreateModel, {
              modelIndex: 0,
            })
            .then(Transformer.Molecule.CreateAssembly, { name: '1' })
            .then(
              Transformer.Molecule.CreateMacromoleculeVisual,
              {
                het: true,
                polymer: true,
                water: false,
          ...
          plugin
            ...
            .then(function() {
              ...
              var theme = {
                ...
                colors: Vis.Molecule.Default.UniformThemeTemplate.colors.set(
                  'Uniform',
                  LiteMol.Visualization.Color.fromHex(0x00bfef),
                ),
              };
              plugin.context.transforms
                .getController(
                  Transformer.Molecule.CreateVisual,
                  plugin.selectEntities('polymer')[0],
                )
                .updateStyleTheme(theme);
              plugin.context.transforms
                .getController(
                  Transformer.Molecule.CreateVisual,
                  plugin.selectEntities('het')[0],
                )
                .updateStyleTheme(theme);
              var streamingEntity = plugin.selectEntities(
                '5ire_density_streaming',
              )[0];
              if (streamingEntity) {
                plugin.command(
                  LiteMol.Bootstrap.Command.Entity.SetCurrent,
                  streamingEntity,
                );
              }
            })
            .catch(function() {
              return suppressCreateModel(false);
            });
          var params = {
      ...
      function _5va1_cryo_em(plugin) {
        ...
        var molecule = plugin
          ...
          .add(plugin.root, Transformer.Data.Download, {
            url:
              'https://webchem.ncbr.muni.cz/CoordinateServer/5va1/full?encoding=bcif&lowPrecisionCoords=1',
            type: 'Binary',
            id: '5va1',
          })
          .then(
      ...
      function HIV1Capsid(plugin) {
        ...
        var molecule = plugin
          ...
          .add(plugin.root, Transformer.Data.Download, {
            url:
              'https://webchem.ncbr.muni.cz/CoordinateServer/3j3q/cartoon?encoding=bcif&lowPrecisionCoords=1',
            type: 'Binary',
            id: '3j3q',
          })
          .then(
          ...
          .then(
            Transformer.Molecule.CreateMacromoleculeVisual,
            { het: true, polymer: true, water: false, polymerRef: 'polymer' },
            {},
          );
        plugin
          .applyTransform(molecule)
          .then(function() {
            suppressCreateModel(false);
            var theme = {
              template: Vis.Molecule.Default.RainbowEntityThemeTemplate,
      ...
      function HIV1Protease(plugin) {
        return __awaiter(this, void 0, void 0, function() {
          function applyColoring() {
            var coloring = plugin
              .createTransform()
              .add('hiv1-validation', Viewer.PDBe.Validation.ApplyTheme, {});
          ...
          return __generator(this, function(_a) {
            switch (_a.label) {
              case 0:
                ...
                molecule = plugin
                  ...
                  .add(
                    ...
                    {
                      url:
                        'https://webchem.ncbr.muni.cz/CoordinateServer/2f80/full?encoding=bcif&lowPrecisionCoords=1',
                      type: 'Binary',
                      id: '2f80',
                    },
                    { ref: rootRef },
                  ...
                  .then(
                    ...
                    {
                      format:
                        LiteMol.Core.Formats.Molecule.SupportedFormats.mmBCIF,
                    },
                    { ref: 'molecule', isBinding: true },
                  )
                  .then(Transformer.Molecule.CreateModel, { modelIndex: 0 })
              ...
              case 1:
                ...
                suppressCreateModel(false);
                plugin.command(
                  LiteMol.Bootstrap.Command.Molecule.CreateSelectInteraction,
                  {
                ...
                plugin.command(
                  LiteMol.Bootstrap.Command.Entity.Focus,
                  plugin.selectEntities('polymer-visual'),
                );
                annotation = plugin
                  .createTransform()
                  .add('molecule', Viewer.PDBe.Validation.DownloadAndCreate, {
                    reportRef: 'hiv1-validation',
                  });
                ...
                streaming = plugin
                  ...
                  .add(
                    'molecule',
                    LiteMol.Extensions.DensityStreaming.Setup,
                    streamingParams,
                  );
                plugin.applyTransform(streaming);
              ...
              case 2:
                _a.sent();
                setTimeout(function() {
                  return applyColoring();
                }, 50);
                unsubscribeOnDelete(
                  plugin,
                  function() {
                    return plugin.subscribe(
                      LiteMol.Bootstrap.Command.Visual.ResetScene,
                      function() {
      ...
      function LigandInteraction_3a4x(plugin) {
        return __awaiter(this, void 0, void 0, function() {
          function applyColoring() {
            var coloring = plugin
              .createTransform()
              .add('validation', Viewer.ValidatorDB.ApplyTheme, {});
          ...
          return __generator(this, function(_a) {
            switch (_a.label) {
              case 0:
                ...
                query = LiteMol.Core.Structure.Query.residues({
                  entityId: '2',
                  authAsymId: 'B',
                  authSeqNumber: 2,
                });
                model = plugin
                  ...
                  .add(
                    ...
                    {
                      url:
                        'https://webchem.ncbr.muni.cz/CoordinateServer/3a4x/ligandInteraction?modelId=1&entityId=2&authAsymId=B&authSeqNumber=2&insCode=&radius=5&atomSitesOnly=1&encoding=bcif&lowPrecisionCoords=1',
                      type: 'Binary',
                      id: '3a4x',
                    },
                    { ref: rootRef },
                  ...
                  .then(Transformer.Molecule.CreateModel, { modelIndex: 0 });
                model.then(Transformer.Molecule.CreateVisual, {
                  style: styleAmb,
                });
                model
                  .then(
              ...
              case 1:
                ...
                annotation = plugin
                  .createTransform()
                  .add('molecule', Viewer.ValidatorDB.DownloadAndCreate, {
                    reportRef: 'validation',
                  });
                annotationTransform = plugin.applyTransform(annotation);
                streamingParams = {
                  server: 'https://webchem.ncbr.muni.cz/DensityServer/',
              ...
              case 2:
                ...
                unsubscribeOnDelete(
                  ...
                  rootRef,
                  function() {
                    return (LiteMol.Bootstrap.Behaviour.Molecule.SuppressShowInteractionOnSelect = false);
                  },
                );
                return [2 /*return*/];
            }
  ...
  (function(Viewer) {
    ...
    Viewer.PluginSpec = {
      settings: {
        ...
        'molecule.coordinateStreaming.defaultServer':
          'https://webchem.ncbr.muni.cz/CoordinateServer',
        'molecule.downloadBinaryCIFFromCoordinateServer.server':
          'https://webchem.ncbr.muni.cz/CoordinateServer',
        ...
        'extensions.densityStreaming.defaultServer':
          'https://webchem.ncbr.muni.cz/DensityServer/',
        'extensions.rnaLoops.defaultServer':
          'http://rna.bgsu.edu/rna3dhub/loops/download/#id',
      },
      transforms: [
        // Root transforms -- things that load data.
        {
          transformer: Viewer.DataSources.ObtainMolecule,
          view: Viewer.Views.ObtainDownload,
        },
        ...
        {
          transformer: Viewer.PDBe.Data.DownloadDensity,
          view: Viewer.PDBe.Views.DownloadDensityView,
        },
        {
          transformer: Viewer.Examples.LoadExample,
          view: Viewer.Views.LoadExample,
        },
        //{ transformer: PDBe.Data.DownloadMolecule, view: Views.Transform.Data.WithIdField, initiallyCollapsed: true },
        {
          ...
          view: Views.Transform.Molecule.InitCoordinateStreaming,
        ...
        {
          transformer: Transformer.Data.Download,
          view: Views.Transform.Data.Download,
          initiallyCollapsed: true,
        },
        {
          transformer: Transformer.Data.OpenFile,
          view: Views.Transform.Data.OpenFile,
          initiallyCollapsed: true,
        },
        // Raw data transforms
        {
          transformer: Transformer.Molecule.CreateFromData,
          view: Views.Transform.Molecule.CreateFromData,
        },
        { transformer: Transformer.Data.ParseCif, view: Views.Transform.Empty },
        {
          transformer: Transformer.Data.ParseBinaryCif,
          view: Views.Transform.Empty,
        },
        {
          transformer: Transformer.Density.ParseData,
          view: Views.Transform.Density.ParseData,
        },
        // Molecule(model) transforms
        {
          transformer: Transformer.Molecule.CreateFromMmCif,
          view: Views.Transform.Molecule.CreateFromMmCif,
        },
        {
          transformer: Transformer.Molecule.CreateModel,
          view: Views.Transform.Molecule.CreateModel,
          initiallyCollapsed: true,
        },
        {
          transformer: Transformer.Molecule.CreateSelection,
          view: Views.Transform.Molecule.CreateSelection,
          initiallyCollapsed: true,
        },
        {
          transformer: Transformer.Molecule.CreateAssembly,
          view: Views.Transform.Molecule.CreateAssembly,
          initiallyCollapsed: true,
        },
        {
        ...
        {
          transformer: Transformer.Molecule.CreateMacromoleculeVisual,
          view: Views.Transform.Empty,
        },
        {
        ...
        {
          transformer: Transformer.Molecule.CreateLabels,
          view: Views.Transform.Molecule.CreateLabels,
        },
        {
        ...
        {
          transformer:
            LiteMol.Extensions.ComplexReprensetation.Carbohydrates.Transforms
              .CreateVisual,
          view:
            LiteMol.Extensions.ComplexReprensetation.Carbohydrates.UI
              .CreateVisual,
        },
        {
          transformer:
            LiteMol.Extensions.ComplexReprensetation.Transforms
              .CreateComplexInfo,
          view: Views.Transform.Empty,
        },
        {
          transformer:
            LiteMol.Extensions.ComplexReprensetation.Transforms.CreateVisual,
          view: Views.Transform.Empty,
        },
        // density transforms
        {
          transformer: Transformer.Density.CreateFromCif,
          view: Views.Transform.Molecule.CreateFromMmCif,
        },
        {
          transformer: Transformer.Density.CreateVisual,
          view: Views.Transform.Density.CreateVisual,
        },
        {
        ...
        {
          transformer: LiteMol.Extensions.DensityStreaming.Setup,
          view: LiteMol.Extensions.DensityStreaming.CreateView,
        },
        {
          transformer: LiteMol.Extensions.DensityStreaming.CreateStreaming,
          view: LiteMol.Extensions.DensityStreaming.StreamingView,
        },
        // Coordinate streaming
        {
          transformer: Transformer.Molecule.CoordinateStreaming.CreateBehaviour,
          view: Views.Transform.Empty,
          initiallyCollapsed: true,
        },
        // Validation reports
        {
          transformer: Viewer.PDBe.Validation.DownloadAndCreate,
          view: Views.Transform.Empty,
        },
        {
          transformer: Viewer.PDBe.Validation.ApplyTheme,
          view: Views.Transform.Empty,
        },
        {
          transformer: Viewer.ValidatorDB.DownloadAndCreate,
          view: Views.Transform.Empty,
        },
        {
          transformer: Viewer.ValidatorDB.ApplyTheme,
          view: Views.Transform.Empty,
        },
        // annotations
        {
          transformer: Viewer.PDBe.SequenceAnnotation.DownloadAndCreate,
          view: Views.Transform.Empty,
          initiallyCollapsed: true,
        },
        {
          transformer: Viewer.PDBe.SequenceAnnotation.CreateSingle,
          view: Viewer.PDBe.Views.CreateSequenceAnnotationView,
          initiallyCollapsed: true,
        },
        {
          transformer: LiteMol.Extensions.RNALoops.DownloadAndCreate,
          view: LiteMol.Extensions.RNALoops.CreateLoopAnnotationView,
          initiallyCollapsed: true,
        },
        {
          transformer: LiteMol.Extensions.RNALoops.ApplyTheme,
          view: Views.Transform.Empty,
      ...
      behaviours: [
        ...
        LiteMol.Extensions.ComplexReprensetation.Transforms
          .CreateRepresentationWhenModelIsAddedBehaviour,
        ...
        // extensions
        LiteMol.Extensions.ComplexReprensetation.Carbohydrates
          .HighlightCustomElementsBehaviour,
      ],
      components: [
        LiteMol.Plugin.Components.Visualization.HighlightInfo(
          LayoutRegion.Main,
          true,
        ),
        LiteMol.Plugin.Components.Entity.Current(
          'LiteMol',
          LiteMol.Plugin.VERSION.number,
        )(LayoutRegion.Right, true),
        ...
        LiteMol.Plugin.Components.Context.BackgroundTasks(
          LayoutRegion.Main,
          true,
        ),
      ],
...
(function(LiteMol) {
  ...
  (function(Viewer) {
    ...
    function createInstance(target, layoutState, ignoreUrlParams) {
      ...
      var pdbId = getParam('loadFromPDB', '[a-z0-9]+')
        .toLowerCase()
        .trim();
      if (pdbId.length === 4) {
        var t = plugin
          .createTransform()
          .add(plugin.root, Viewer.PDBe.Data.DownloadMolecule, { id: pdbId });
      ...
      if (downloadUrl) {
        ...
        switch (getParam('loadFromURLFormat', '[a-z]+')
          .toLocaleLowerCase()
          .trim()) {
          case 'pdb':
        ...
        var t = plugin
          .createTransform()
          .add(plugin.root, Viewer.DataSources.DownloadMolecule, {
            id: downloadUrl,
            format: format,
          });
        plugin.applyTransform(t);
      ...
      var example =
        Viewer.Examples.ExampleMap[
          getParam('example', '[a-z0-9-]+')
            .toLowerCase()
            .trim()
        ];
