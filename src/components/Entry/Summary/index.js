...
const Wikipedia = ({ title, extract, thumbnail }) => {
  return (
    <div className={f('wiki-article')}>
      <h4 className={f('wiki-title')}>
        Wikipedia:{' '}
        <Link
          className={f('ext')}
          target="_blank"
      ...
      <div className={f('row')}>
        ...
        <div className={f('medium-4', 'large-4', 'columns', 'infobox')}>
          <table className={f('infobox')}>
            <tbody>
              <tr>
                <th colSpan="2" className={f('img-title')}>
                  {title}
                </th>
              </tr>
              <tr>
          ...
          {/*<div className={f('img-title')}>{title}</div>*/}
          {/*<img*/}
          {/*  src={`data:image/png;base64, ${thumbnail}`}*/}
          {/*  alt="Red dot"*/}
          {/*/>*/}
        ...
        <section>
          <div className={f('row')}>
            <div className={f('medium-8', 'large-8', 'columns')}>
              ...
              {/*<div className={f('wiki-article')}>*/}
              {/*  <h4>Wikipedia: {wikiJson.title}</h4>*/}
