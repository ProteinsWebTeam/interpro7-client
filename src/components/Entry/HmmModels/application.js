...
(function($) {
  ...
  $(document).ready(function() {
    ...
    if (window.FileReader) {
      if (
        $('#file_upload').length > 0 &&
        $('#file_upload').get(0).files.length >= 1
      ) {
    ...
    $.fn.tooltip = function() {
      $(this).each(function() {
        ...
        content
          .append('<br/>')
          .append($('<a>more</a>').attr('href', $(this).attr('href')))
          .html();
