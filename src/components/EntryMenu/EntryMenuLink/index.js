...
class EntryMenuLink extends PureComponent /*:: <Props> */ {
  ...
  render() {
    ...
    const icons = new Map([
      ...
      ['Domain Architectures', { class: 'icon-count-ida' }],
      ['Taxonomy', { class: 'icon-count-species' }],
      ['Proteomes', { class: 'icon-count-proteome' }],
      ['Sets', { class: 'icon-count-set' }],
      ['Signature', { class: 'icon-count-hmm' }],
