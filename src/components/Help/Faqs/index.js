            ...
            <details className={f('accordion-style')}>
              ...
              <div className={f('accordion-info')}>
                <p>
                  ...
                  via the web, the InterProScan software package can be
                  downloaded for local installation from the{' '}
                  <Link
            ...
            <details className={f('accordion-style')}>
              ...
              <div className={f('accordion-info')}>
                <p>
                  ...
                  that allow up to one sequence per request, and up to 25
                  requests in parallel (both{' '}
                  <Link
            ...
            <details className={f('accordion-style')}>
              ...
              <div className={f('accordion-info')}>
                <p>
                  ...
                  and either the Jaccard index (equivalent) or containment index
                  (parent/child) of the matching sequence sets is greater than
                  0.75.
                </p>
              </div>
            </details>
            ...
            <details className={f('accordion-style')}>
              ...
              <div className={f('accordion-info')}>
                <p>
                  ...
                  are from the same or related InterPro entries will be coloured
                  the same, allowing easy visualisation of domains we know to be
                  related. Unintegrated signatures will always be grey blobs,
                  family signatures will always be shown as white, and sites
                  will always be black when this option is selected. If you
                  select &ldquo;Colour by: member database&rdquo;, each blob in
                  the sequence features section will be coloured according to
                  the member database that provides the signature, as shown in
                  this diagram. However, the sequence summary view will retain
                  the domain relationship colour scheme.
                </p>
              </div>
            </details>
            ...
            <details className={f('accordion-style')}>
              ...
              <div className={f('accordion-info')}>
                <p>
                  ...
                  compared or combined. For this reason, we do not show e-values
                  on the InterPro web site. However, e-values can be obtained
                  via the downloadable InterProScan software package, which
                  outputs detailed individual results for each member database
            ...
            <details className={f('accordion-style')}>
              ...
              <div className={f('accordion-info')}>
                <p>
                  ...
                  the ftp site for download and distribution, provided the
                  following Copyright line notice is supplied:{' '}
                  <i>
                    InterPro - Integrated Resource Of Protein Domains And
                    Functional Sites. Copyright (C) 2001 The InterPro
                    Consortium.
                  </i>
                </p>
              </div>
