      ...
      <section>
        ...
        <details className={f('accordion-style')}>
          ...
          <p>
            ...
            <Link href="/help/training/">Training &amp; tutorials</Link> page.
          </p>
        </details>
        ...
        <details className={f('accordion-style')}>
          ...
          <div>
            <p>
              ...
              tell you what you can infer when a protein matches the entry. The
              entry types are:
            </p>
            ...
            <ul className={f('flex-grid')}>
              <li>
                ...
                evolutionary origin, reflected by similarity in their structure.
                Since superfamily members often display very low similarity at
                the sequence level, this type of InterPro entry is usually based
                on a collection of underlying hidden Markov models, rather than
                a single signature.
              </li>
              <li>
                {' '}
                <interpro-type
                  ...
                  aria-label="Entry type"
                />{' '}
                <strong>Family</strong>: A protein family is a group of proteins
                that share a common evolutionary origin reflected by their
                related functions, similarities in sequence, or similar primary,
                secondary or tertiary structure. A match to an InterPro entry of
                this type indicates membership of a protein family.
              </li>
              <li>
                {' '}
                <interpro-type
                ...
                biological contexts. A match to an InterPro entry of this type
              ...
              <li>
                ...
                <interpro-type
                  ...
                  aria-label="Entry type"
                />
                <strong>Repeat</strong>: A match to an InterPro entry of this
                type identifies a short sequence that is typically repeated
                within a protein.
              </li>
              <li>
                {' '}
                <interpro-type
                  ...
                  aria-label="Entry type"
                />
                <strong>Site</strong>: A match to an InterPro entry of this type
                indicates a short sequence that contains one or more conserved
                residues. The type of sites covered by InterPro are active
                sites, binding sites, post-translational modification sites and
                conserved sites.
              </li>
              <li>
                {' '}
        ...
        <details className={f('accordion-style')}>
          ...
          <div>
            <p>
              ...
              subfamilies or structural/functional subclasses of domains.
            </p>
            <p>
              For example, steroid hormone receptors constitute a family of
              nuclear receptors responsible for signal transduction mediated by
              steroid hormones, and can be sub-classified into different groups,
              including the liver X receptor subfamily. This subfamily consists
              of nuclear receptors that regulate the metabolism of several
              important lipids, including oxysterols.
            </p>
          </div>
        </details>
        ...
        <details className={f('accordion-style')}>
          ...
          <div>
            <p>
              ...
              quality (i.e., they match the proteins they are supposed to and
              hit as few incorrect proteins as possible).
            </p>
            <p>
              While matches to InterPro should therefore be trustworthy, there
              are some caveats. Most proteins are currently uncharacterised, so
              quality checks can only ever be based on the subset of
              characterised proteins that match the signature. It is therefore
              possible that signatures can match false positives that have not
              been detected.
            </p>
            <p>
              A useful rule of thumb is that the more signatures within an
              InterPro entry that match a protein, the more likely it is that
              the match is correct. Matches within the same hierarchy would also
              tend to increase confidence, as they all imply membership of a
              particular group.
            </p>
            <p>
              Nevertheless, please bear in mind that the member database
              signatures are computational predictions. If you think one of our
              signatures matches false positives, please{' '}
              <Link
        ...
        <details className={f('accordion-style')}>
          ...
          <p>
            ...
            line notice is supplied:{' '}
            <i>
              InterPro - Integrated Resource Of Protein Domains And Functional
              Sites. Copyright (C) 2001 The InterPro Consortium.
            </i>
          </p>
        </details>
        ...
        <details className={f('accordion-style')}>
          ...
          <p>
            We welcome your contributions. To report errors or problems with the
            database, please{' '}
            <Link
              href="//www.ebi.ac.uk/support/interpro-general-query"
              className={f('ext')}
