      ...
      <section>
        <div className={f('row')}>
          <div className={f('columns', 'large-8')}>
            ...
            <div>
              ...
              <details className={f('accordion-style')}>
                ...
                <div className={f('accordion-info')}>
                  <p>
                    Each InterPro entry is assigned one of a number of types
                    which tell you what you can infer when a protein matches the
                    entry. The entry types are:
                  </p>

                  <ul className={f('flex-columns')}>
                    <li>
                      {' '}
                      <interpro-type
                        dimension="3em"
                      ...
                      structure. Since superfamily members often display very
                      low similarity at the sequence level, this type of
                      InterPro entry is usually based on a collection of
                      underlying hidden Markov models, rather than a single
                      signature.
                    </li>
                    <li>
                      {' '}
                      ...
                      similar primary, secondary or tertiary structure. A match
                      to an InterPro entry of this type indicates membership of
                      a protein family.
                    </li>
                    <li>
                      {' '}
                      ...
                      structural or sequence units that may exist in a variety
                      of biological contexts. A match to an InterPro entry of
                    ...
                    <li>
                      ...
                      />
                      <br />
                      <strong>Site</strong>: A match to an InterPro entry of
                      this type indicates a short sequence that contains one or
                      more conserved residues. The type of sites covered by
                      InterPro are active sites, binding sites,
                    ...
                    <li>
                      ...
                      signatures that have been grouped into InterPro entries,
                      you can also find unintegrated signatures that might not
                      yet be curated or might not reach InterPro&apos;s
                      standards for integration. However, they may provide
              ...
              <details className={f('accordion-style')}>
                ...
                <div className={f('accordion-info')}>
                  <p>
                    ...
                    more specific functional subfamilies or
                    structural/functional subclasses of domains.
                  </p>
                  <p>
                    For example, steroid hormone receptors constitute a family
                    of nuclear receptors responsible for signal transduction
                    mediated by steroid hormones, and can be sub-classified into
                    different groups, including the liver X receptor subfamily.
                    This subfamily consists of nuclear receptors that regulate
                    the metabolism of several important lipids, including
                    oxysterols.
                  </p>
                </div>
              </details>
              ...
              <details className={f('accordion-style')}>
                ...
                <div className={f('accordion-info')}>
                  <p>
                    ...
                    analysing the overlap between matched sequence sets. An
                    InterPro entry is considered related to a homologous
                    superfamily if its sequence matches overlap (i.e., the match
                    positions fall within the homologous superfamily boundaries)
                    and either the Jaccard index (equivalent) or containment
                    index (parent/child) of the matching sequence sets is
                    greater than 0.75.
                  </p>
                </div>
              </details>
              ...
              <details className={f('accordion-style')}>
                <summary>
                  What do the colours mean in the graphical view of matches to
                  my protein?
                </summary>
                {
                  // Text need an update
                ...
                <div className={f('accordion-info')}>
                  <p>
                    The graphical view of InterPro matches show where the
                    signatures that match your protein appear on the sequence.
                    There are two ways that these graphical &ldquo;blobs&rdquo;
                    can be coloured. If you select &ldquo;Colour by: domain
                    relationship&rdquo;, in the left hand menu, the domains that
                    are from the same or related InterPro entries will be
                    coloured the same, allowing easy visualisation of domains we
                    know to be related. Unintegrated signatures will always be
                    grey blobs, family signatures will always be shown as white,
                    and sites will always be black when this option is selected.
                    If you select &ldquo;Colour by: member database&rdquo;, each
                    blob in the sequence features section will be coloured
                    according to the member database that provides the
                    signature, as shown in this diagram. However, the sequence
                    summary view will retain the domain relationship colour
                    scheme.
                  </p>
                </div>
              </details>
              ...
              <details className={f('accordion-style')}>
                ...
                <div className={f('accordion-info')}>
                  <p>
                    ...
                    different ways by different member databases, so their
                    e-values and/or scoring systems cannot be meaningfully
                    compared or combined. For this reason, we do not show
                    e-values on the InterPro web site. However, e-values can be
                    obtained via the downloadable InterProScan software package,
                    which outputs detailed individual results for each member
              ...
              <details className={f('accordion-style')}>
                ...
                <div className={f('accordion-info')}>
                  <p>
                    The database and related software are freely available from
                    the
                    <Link
              ...
              <details className={f('accordion-style')}>
                <summary>How do I cite InterPro?</summary>
                <div className={f('accordion-info')}>
                  <p>
                    See details
                    <Link
            ...
            <div>
              <h4>Sequence searches (InterProScan)</h4>
              <details className={f('accordion-style')}>
                <summary>
                ...
                <div className={f('accordion-info')}>
                  <p>
                    ...
                    have privacy concerns about submitting sequences for
                    analysis via the web, the InterProScan software package can
                    be downloaded for local installation from the{' '}
                    <Link
              ...
              <details className={f('accordion-style')}>
                ...
                <div className={f('accordion-info')}>
                  <p>
                    InterProScan can be accessed programmatically via Web
                    services that allow up to one sequence per request, and up
                    to 25 requests in parallel (both{' '}
                    <Link
              ...
              <details className={f('accordion-style')}>
                ...
                <div className={f('accordion-info')}>
                  <p>
                    We make every effort to ensure that signatures integrated
                    into InterPro are accurate. Before being integrated,
                    signatures are manually checked by curators to ensure that
                    they are of a high quality (i.e., they match the proteins
                    they are supposed to and hit as few incorrect proteins as
                    possible).
                  </p>
                  <p>
                    ...
                    the subset of characterised proteins that match the
                    signature. It is therefore possible that signatures can
                    match false positives that have not been detected.
                  </p>
                  <p>
                  ...
                  <p>
                    ...
                    signatures are computational predictions. If you think one
                    of our signatures matches false positives, please{' '}
                    <Link
                      href="//www.ebi.ac.uk/support/interpro"
                      className={f('ext')}
                      target="_blank"
            ...
            <div>
              ...
              <details className={f('accordion-style')}>
                ...
                <div className={f('accordion-info')}>
                  <p>
                    Some functionality of the InterPro website, particularly
                    InterProScan searches and downloading data make use of
                    Browser storage. These functions require the user to agree
                    to EMBl-EBI cookies and are incompatible with browser
                    Incognito/Privacy modes.
                  </p>
                  <p>
                    Please grant permission for cookies and browse the site in a
                    standard user session to fully enable functionality of the
                    InterPro website.
                  </p>
                </div>
              </details>
