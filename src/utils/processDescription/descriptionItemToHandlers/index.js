...
export default new Map([
  ...
  ['entry.order', new Set([handlers.orderHandler])],
  ['protein.order', new Set([handlers.orderHandler])],
  ['structure.order', new Set([handlers.orderHandler])],
  ['taxonomy.order', new Set([handlers.orderHandler])],
  ['proteome.order', new Set([handlers.orderHandler])],
