      ...
      <div className={f('columns', 'browse-by')}>
        ...
        <div className={f('callout')} data-equalizer-watch>
              ...
              <ul className={f('tabs')} data-tabs id="example-tabs">
                <li className={f('tabs-panel','is-active')} aria-selected="true"><a href="#panel1">by member database</a></li>
                <li className={f('tabs-title')}><a href="#panel2" >by entry type</a></li>
                <li className={f('tabs-title')}><a href="#panel3">by species</a></li>
                <li className={f('tabs-title')}><a href="#panel4">by GO term</a></li>
              </ul>
          ...
          <div className={f('tabs','tabs-content')} data-tabs-content="example-tabs">
                ...
                {//Database CATH
                  ...
                  <div className={f('columns', 'medium-3', 'large-3', 'text-center')}>
                    <a href="entry/gene3d" className={f('md-cg')}>
                      ...
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 200" className={f('md-cg')}>
                      ...
                      </h6><p ><small>3.5.0</small><br/><span >11273 entries</span></p></a>
                  </div>
                ...
                {//Database CDD
                  ...
                  <div className={f('columns', 'medium-3', 'large-3', 'text-center')}>
                    ...
                    <a href="entry/cdd" className={f('md-cd')}>
                      ...
                      </h6><p ><small>3.14</small><br/><span>2626 entries</span></p></a>
                  </div>
                ...
                <div className={f('columns', 'medium-3', 'large-3', 'text-center')}>
                  ...
                  <a href="contact/" >
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 200" >
                      ...
                      <text x="50%" y="50%" textAnchor="middle" dx="-0.01em" dy="0.4em" fill="grey" style={{fontSize:100, fontWeight:'bold'}}>?</text>
                    </svg>
            ...
            <div className={f('tabs-panel','entrytype-panel')} id="panel2" style={{display: ('block')}}>
               <div className={f('row')}>
                ...
                <div className={f('columns', 'medium-4', 'large-4', 'text-center')}>
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 200 200" className={f('svg-mask')} >
                    <defs>
                      <clipPath id="cut-off-bottom">
                        <polygon points="0,68 68,0 68,68"></polygon>
                      </clipPath>
                    </defs>
                  </svg>

                  <a href="#" data-tooltip  title="This icon represent a domain type of InterPro entry">
                    <div  className={f('my-svg-container')}>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 72 72" id="type-domain" >
                      <rect x="12" y="12" width="60" height="60" style={{fill: ('black'), opacity:0.15 }}></rect>
                      <rect x="4" y="4" width="60" height="60" strokeWidth="8" stroke="#36a30f" style={{fill: ('#50bb30')}}></rect>
                      <polygon points="0,68 68,0 68,68" style={{fill: ('#36a30f')}}></polygon>
                  ...
                  <h5>Domain <span className={f('small', 'icon', 'icon-generic')} data-icon="i" data-tooltip title="Domains are distinct functional, structural or sequence units that may exist in a variety of biological contexts. A match to an InterPro entry of this type indicates the presence of a domain."></span></h5><p>8439 entries<br/></p> </a>
                </div>
                ...
                <div className={f('columns', 'medium-4', 'large-4', 'text-center')}>
                  <a href="#" data-tooltip  title="This icon represent a Family type of InterPro entry">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 72 72" id="type-family" >
                      <rect x="12" y="12" width="60" height="60" style={{fill: ('black'), opacity:0.15 }}></rect>
                      <rect x="4" y="4" width="60" height="60" strokeWidth="8" stroke="#d41813" style={{fill: ('#f54528')}}></rect>
                      <polygon points="0,68 68,0 68,68" style={{fill: ('#d41813')}}></polygon>
                ...
                <div className={f('columns', 'medium-4', 'large-4', 'text-center')}>
                  <a href="#" data-tooltip  title="This icon represent a site type of InterPro entry" >
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 72 72" id="type-site" >
                      <rect x="12" y="12" width="60" height="60" style={{fill: ('black'), opacity:0.15 }}></rect>
                      <rect x="4" y="4" width="60" height="60" strokeWidth="8" stroke="#a83cc9" style={{fill: ('#c646ec')}}></rect>
                      <polygon points="0,68 68,0 68,68" style={{fill: ('#a83cc9')}}></polygon>
                  ...
                  <h5>Sites <span className={f('small', 'icon', 'icon-generic')} data-icon="i" data-tooltip title="A short sequence that contains one or more conserved residues. The type of sites covered by InterPro are active sites, binding sites, post-translational modification sites and conserved sites"></span></h5><p>755 entries<br/></p>
                  </a>
                </div>
                ...
                <div className={f('columns', 'medium-4', 'large-4', 'text-center')}>
                  ...
                  <a href="#" data-tooltip  title="This icon represent a repeat type of InterPro entry" >
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 72 72" id="type-repeat" >
                      <rect x="12" y="12" width="60" height="60" style={{fill: ('black'), opacity:0.15 }}></rect>
                      <rect x="4" y="4" width="60" height="60" strokeWidth="8" stroke="#ff8511" style={{fill: ('#ffa249')}}></rect>
                      <polygon points="0,68 68,0 68,68" style={{fill: ('#ff8511')}}></polygon>
                  ...
                  <h5>Repeat <span className={f('small', 'icon', 'icon-generic')} data-icon="i" data-tooltip title="It identifies a short sequence that is typically repeated within a protein."></span></h5><p>755 entries<br/></p>
                  </a>
                </div>
                ...
                <div className={f('columns', 'medium-4', 'large-4', 'text-center')}>
                  <a href="#" data-tooltip  title="This icon represent a Clan type of InterPro entry"  >
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 72 72" id="type-clan" >
                      <rect x="12" y="12" width="60" height="60" style={{fill: ('black'), opacity:0.15 }}></rect>
                      <rect x="4" y="4" width="60" height="60" strokeWidth="8" stroke="#1f64b3" style={{fill: ('#1e77dc')}}></rect>
                      <polygon points="0,68 68,0 68,68" style={{fill: ('#1f64b3')}}></polygon>
                  ...
                  <h5>Clans <span className={f('small', 'icon', 'icon-generic')} data-icon="i" data-tooltip title="Clans are a collection of families"></span></h5><p>18 entries<br/></p></a>
                </div>
                ...
                <div className={f('columns', 'medium-4', 'large-4', 'text-center')}>
                  <a href="#" data-tooltip  title="This icon represent an unintegrated type of InterPro entry">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 72 72" id="type-unintegrated">
                      <rect x="12" y="12" width="60" height="60" style={{fill: ('black'), opacity:0.15 }}></rect>
                      <rect x="4" y="4" width="60" height="60" strokeWidth="8" stroke="#737373" style={{fill: ('#8c8c8c')}}></rect>
                      <polygon points="0,68 68,0 68,68" style={{fill: ('#737373')}}></polygon>
                  ...
                  <h5>Unintegrated <span className={f('small', 'icon', 'icon-generic')} data-icon="i" data-tooltip title="Signatures that doesn't belong to any type are what we call unintegrated"></span></h5><p>16852 signatures<br/></p>
                  </a>
                </div>
              </div>

              <a href="#" className={'button'} style={{marginTop: 1}}>View all entries</a>
